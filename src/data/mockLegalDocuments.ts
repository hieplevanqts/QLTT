import { LegalDocument } from '../ui-kit/LegalDocumentItem';
...
export const generateLegalDocuments = (storeId: number): LegalDocumentData[] => {
  ...
  const baseDocuments: LegalDocumentData[] = [
    ...
    },
    {
      ...
      issuingAuthority: 'Sở KH&ĐT TP.HCM',
    ...
    },
    {
      ...
      issuingAuthority: 'Chi cục ATTP TP.HCM',
      notes: '',
    ...
    },
    {
      ...
      ...(completionLevel >= 2 ? {} : {
        ...
        issuingAuthority: `Phòng Cảnh sát PCCC Quận ${storeId % 12 + 1}`,
        notes: '',
