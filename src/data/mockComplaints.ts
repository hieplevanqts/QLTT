...
export const mockComplaints: ComplaintRecord[] = [
  ...
  },
  {
    ...
    source: 'hotline',
    severity: 'high',
    assignedUnit: 'Chi cục QLTT Quận 1',
    status: 'resolved',
  ...
  // Store ID 4 - Multiple high-severity complaints
  {
    ...
    source: 'phone',
    severity: 'high',
    assignedUnit: 'Chi cục QLTT Quận 4',
    status: 'verifying',
