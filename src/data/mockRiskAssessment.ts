...
export const mockRiskAssessments: RiskAssessment[] = [
  // Store ID 1 - Medium Risk
  {
    ...
    assessedBy: 'Trần Văn B - Đội QLTT Quận 1',
    factors: [
      {
        id: 'F1',
  ...
  // Store ID 2 - High Risk
  {
    ...
    assessedBy: 'Hoàng Thị E - Đội QLTT Quận 2',
    factors: [
      {
        id: 'F1',
        name: 'Lịch sử vi phạm',
    ...
    monitoringHistory: [
      {
        ...
        flaggedBy: 'Hoàng Thị E - Đội QLTT Quận 2',
  ...
  // Store ID 3 - Low Risk
  {
    ...
    assessedBy: 'Nguyễn Văn A - Đội QLTT Quận 3',
    factors: [
      {
        id: 'F1',
        name: 'Lịch sử vi phạm',
  ...
  // Store ID 4 - Very High Risk
  {
    ...
    assessedBy: 'Hoàng Thị E - Chi cục QLTT Quận 4',
    factors: [
      {
        id: 'F1',
        name: 'Lịch sử vi phạm',
    ...
    monitoringHistory: [
      {
        ...
        flaggedBy: 'Hoàng Thị E - Chi cục QLTT Quận 4',
      ...
      },
      {
        ...
        flaggedBy: 'Trần Văn B - Đội QLTT Quận 4',
