import svgPaths from "./svg-9z2hkgggpv";
...
function Text() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[98.391px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-[49.5px] not-italic text-[#101828] text-[16px] text-center top-[-1px] translate-x-[-50%] w-[99px] whitespace-pre-wrap">Xin chào, Gg</p>
      </div>
    </div>
  );
}
...
function Button() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[40px] items-center left-[24px] top-[11.5px] w-[146.391px]" data-name="Button">
      <ImageMappaLogo />
      <Container />
    </div>
  );
...
function GlobalSearch() {
  return (
    <div className="absolute h-[40px] left-[368.34px] top-[11.5px] w-[576px]" data-name="GlobalSearch">
      <TextInput />
      <Icon />
    </div>
  );
...
function Container1() {
  return (
    <div className="absolute h-[36px] left-[1324.25px] top-[13.5px] w-[185.75px]" data-name="Container">
      <Button1 />
      <Button2 />
      <Button3 />
      <Button4 />
...
function Dropdown() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[41px] items-start left-[1026px] pb-px pl-[-1072px] pr-[1292px] pt-[-147.5px] rounded-[8px] top-px w-[220px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Option />
      <Option1 />
      <Option2 />
...
function Dropdown1() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[41px] items-start left-[1262px] pb-px pl-[-1308px] pr-[1488px] pt-[-147.5px] rounded-[8px] top-px w-[180px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Option6 />
      <Option7 />
      <Option8 />
...
function TextInput1() {
  return (
    <div className="absolute bg-white h-[43px] left-0 rounded-[8px] top-0 w-[1010px]" data-name="Text Input">
...
function Container7() {
  return (
    <div className="absolute h-[43px] left-0 top-0 w-[1010px]" data-name="Container">
      <TextInput1 />
      <Icon26 />
    </div>
  );
...
function Dropdown2() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[41px] items-start left-0 pb-px pl-[-46px] pr-[226px] pt-[-202.5px] rounded-[8px] top-px w-[180px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Option10 />
      <Option11 />
      <Option12 />
...
function Dropdown3() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[41px] items-start left-[196px] pb-px pl-[-242px] pr-[442px] pt-[-202.5px] rounded-[8px] top-px w-[200px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Option13 />
      <Option14 />
      <Option15 />
...
function Dropdown4() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[41px] items-start left-[412px] pb-px pl-[-458px] pr-[638px] pt-[-202.5px] rounded-[8px] top-px w-[180px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Option19 />
      <Option20 />
      <Option21 />
...
function Container9() {
  return (
    <div className="absolute h-[43px] left-[873.27px] top-0 w-[568.734px]" data-name="Container">
      <Button24 />
      <Button25 />
      <Button26 />
      <Button27 />
...
function HeaderCell() {
  return (
    <div className="absolute h-[42.5px] left-0 top-0 w-[197.953px]" data-name="Header Cell">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-[16px] not-italic text-[#667085] text-[12px] top-[12px] tracking-[0.5px] uppercase whitespace-pre">Mã Quy Tắc</p>
    </div>
  );
}
...
function HeaderCell1() {
  return (
    <div className="absolute h-[42.5px] left-[197.95px] top-0 w-[198px]" data-name="Header Cell">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-[16px] not-italic text-[#667085] text-[12px] top-[12px] tracking-[0.5px] uppercase whitespace-pre">Tên Quy Tắc</p>
    </div>
  );
}
...
function HeaderCell2() {
  return (
    <div className="absolute h-[42.5px] left-[395.95px] top-0 w-[180px]" data-name="Header Cell">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-[16px] not-italic text-[#667085] text-[12px] top-[12px] tracking-[0.5px] uppercase whitespace-pre">Loại Sự Kiện</p>
    </div>
  );
}
...
function HeaderCell3() {
  return (
    <div className="absolute h-[42.5px] left-[575.95px] top-0 w-[200px]" data-name="Header Cell">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-[16px] not-italic text-[#667085] text-[12px] top-[12px] tracking-[0.5px] uppercase whitespace-pre">Vai Trò Nhận</p>
    </div>
  );
}
...
function HeaderCell4() {
  return (
    <div className="absolute h-[42.5px] left-[775.95px] top-0 w-[140px]" data-name="Header Cell">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-[16px] not-italic text-[#667085] text-[12px] top-[12px] tracking-[0.5px] uppercase whitespace-pre">Phạm Vi</p>
    </div>
  );
}
...
function HeaderCell5() {
  return (
    <div className="absolute h-[42.5px] left-[915.95px] top-0 w-[140px]" data-name="Header Cell">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-[16px] not-italic text-[#667085] text-[12px] top-[12px] tracking-[0.5px] uppercase whitespace-pre">Kênh</p>
    </div>
  );
}
...
function HeaderCell6() {
  return (
    <div className="absolute h-[42.5px] left-[1055.95px] top-0 w-[120px]" data-name="Header Cell">
...
function HeaderCell7() {
  return (
    <div className="absolute h-[42.5px] left-[1175.95px] top-0 w-[106.047px]" data-name="Header Cell">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-[16px] not-italic text-[#667085] text-[12px] top-[12px] tracking-[0.5px] uppercase whitespace-pre">Ưu Tiên</p>
    </div>
  );
}
...
function Code() {
  return (
    <div className="absolute bg-[#f2f4f7] content-stretch flex h-[21px] items-start left-[16px] px-[6px] py-[2px] rounded-[4px] top-[29.5px] w-[112.078px]" data-name="Code">
...
function TableCell() {
  return (
    <div className="absolute h-[79px] left-0 top-0 w-[197.953px]" data-name="Table Cell">
      <Code />
    </div>
  );
}
...
function Text4() {
  return (
    <div className="absolute h-[42px] left-[16px] top-[18.5px] w-[166px]" data-name="Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101828] text-[14px] top-0 w-[130px] whitespace-pre-wrap">Cảnh báo SLA vượt ngưỡng nguy hiểm</p>
    </div>
  );
}
...
function TableCell1() {
  return (
    <div className="absolute h-[79px] left-[197.95px] top-0 w-[198px]" data-name="Table Cell">
      <Text4 />
    </div>
  );
}
...
function Text5() {
  return (
    <div className="absolute h-[21px] left-0 top-0 w-[114.656px]" data-name="Text">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#101828] text-[14px] top-0 whitespace-pre">SLA vượt ngưỡng</p>
    </div>
  );
}
...
function Container12() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[120.66px] size-[14px] top-[3.5px]" data-name="Container">
      <Icon32 />
    </div>
  );
}
...
function Container13() {
  return (
    <div className="absolute h-[21px] left-[16px] top-[29px] w-[148px]" data-name="Container">
      <Text5 />
      <Container12 />
    </div>
  );
...
function TableCell2() {
  return (
    <div className="absolute h-[79px] left-[395.95px] top-0 w-[180px]" data-name="Table Cell">
      <Container13 />
    </div>
  );
}
...
function Text6() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[128.578px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#667085] text-[14px] whitespace-pre">Giám sát, Giám đốc</p>
    </div>
  );
}
...
function TableCell3() {
  return (
    <div className="absolute h-[79px] left-[575.95px] top-0 w-[200px]" data-name="Table Cell">
      <Text6 />
    </div>
  );
}
...
function Text7() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[42.109px]" data-name="Text">
...
function TableCell4() {
  return (
    <div className="absolute h-[79px] left-[775.95px] top-0 w-[140px]" data-name="Table Cell">
      <Text7 />
    </div>
  );
}
...
function Text8() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[76.188px]" data-name="Text">
...
function TableCell5() {
  return (
    <div className="absolute h-[79px] left-[915.95px] top-0 w-[140px]" data-name="Table Cell">
      <Text8 />
    </div>
  );
}
...
function Icon33() {
  return (
    <div className="absolute left-[10px] size-[10.391px] top-[18px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.3906 10.3906">
        <g id="Icon">
          <path d={svgPaths.p67ccc00} id="Vector" stroke="var(--stroke-0, #0F9D58)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.865885" />
          <path d={svgPaths.p315d1380} id="Vector_2" stroke="var(--stroke-0, #0F9D58)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.865885" />
        </g>
      </svg>
    </div>
  );
...
function Text9() {
  return (
    <div className="absolute bg-[#e6f4ea] h-[50px] left-[16px] rounded-[8px] top-[14.5px] w-[88px]" data-name="Text">
      <Icon33 />
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[21px] left-[26.39px] not-italic text-[#0f9d58] text-[14px] top-[4px] w-[35px] whitespace-pre-wrap">Hoạt động</p>
    </div>
  );
}
...
function TableCell6() {
  return (
    <div className="absolute h-[79px] left-[1055.95px] top-0 w-[120px]" data-name="Table Cell">
      <Text9 />
    </div>
  );
}
...
function Text10() {
  return (
    <div className="absolute bg-[#fce8e6] h-[29px] left-[16px] rounded-[8px] top-[25px] w-[51.063px]" data-name="Text">
...
function TableCell7() {
  return (
    <div className="absolute h-[79px] left-[1175.95px] top-0 w-[106.047px]" data-name="Table Cell">
      <Text10 />
    </div>
  );
}
...
function Code1() {
  return (
    <div className="absolute bg-[#f2f4f7] content-stretch flex h-[21px] items-start left-[16px] px-[6px] py-[2px] rounded-[4px] top-[29.5px] w-[119.766px]" data-name="Code">
...
function Text11() {
  return (
    <div className="absolute h-[21px] left-[16px] top-[29px] w-[165.375px]" data-name="Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101828] text-[14px] top-0 whitespace-pre">Lead nhạy cảm được tạo</p>
    </div>
  );
}
...
function Text13() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[143.438px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#667085] text-[14px] whitespace-pre">Quản trị, IT, Giám đốc</p>
    </div>
  );
}
...
function Text14() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[95.047px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#101828] text-[14px] whitespace-pre">Toàn hệ thống</p>
    </div>
  );
}
...
function Text15() {
  return (
    <div className="absolute h-[38px] left-[16px] top-[20.5px] w-[102.719px]" data-name="Text">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-[-2px] w-[103px] whitespace-pre-wrap">Push, Email, Hệ thống</p>
    </div>
  );
}
...
function Code2() {
  return (
    <div className="absolute bg-[#f2f4f7] content-stretch flex h-[21px] items-start left-[16px] px-[6px] py-[2px] rounded-[4px] top-[29.5px] w-[150.563px]" data-name="Code">
...
function Text18() {
  return (
    <div className="absolute h-[21px] left-[16px] top-[29px] w-[157.844px]" data-name="Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101828] text-[14px] top-0 whitespace-pre">Thay đổi dữ liệu master</p>
    </div>
  );
}
...
function Text19() {
  return (
    <div className="absolute h-[42px] left-0 top-0 w-[128px]" data-name="Text">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#101828] text-[14px] top-0 w-[128px] whitespace-pre-wrap">Dữ liệu master thay đổi</p>
    </div>
  );
}
...
function Container18() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[134px] size-[14px] top-[14px]" data-name="Container">
      <Icon42 />
    </div>
  );
}
...
function Container19() {
  return (
    <div className="absolute h-[42px] left-[16px] top-[18.5px] w-[148px]" data-name="Container">
      <Text19 />
      <Container18 />
    </div>
  );
...
function Text20() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[121.813px]" data-name="Text">
...
function Text22() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[103.906px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#667085] text-[14px] whitespace-pre">Hệ thống, Email</p>
    </div>
  );
}
  ...
  return (
    <div className="absolute left-[10px] size-[10.391px] top-[18px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.3906 10.3906">
        <g id="Icon">
          <path d={svgPaths.p67ccc00} id="Vector" stroke="var(--stroke-0, #0F9D58)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.865885" />
          <path d={svgPaths.pd22ff40} id="Vector_2" stroke="var(--stroke-0, #0F9D58)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.865885" />
        </g>
      </svg>
    </div>
  );
...
function Text24() {
  return (
    <div className="absolute bg-[#fff3e0] h-[29px] left-[16px] rounded-[8px] top-[25px] w-[74.047px]" data-name="Text">
...
function TableRow3() {
  return (
    <div className="absolute border-[#d0d5dd] border-[0px_0px_1px] border-solid h-[79px] left-0 top-[158px] w-[1482px]" data-name="Table Row">
      <TableCell18 />
      <TableCell19 />
      <TableCell20 />
      <TableCell21 />
...
function Code3() {
  return (
    <div className="absolute bg-[#f2f4f7] content-stretch flex h-[21px] items-start left-[16px] px-[6px] py-[2px] rounded-[4px] top-[29.5px] w-[96.672px]" data-name="Code">
...
function Text25() {
  return (
    <div className="absolute h-[21px] left-[16px] top-[29px] w-[161.453px]" data-name="Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101828] text-[14px] top-0 whitespace-pre">Job xuất dữ liệu thất bại</p>
    </div>
  );
}
...
function Text26() {
  return (
    <div className="absolute h-[42px] left-0 top-0 w-[128px]" data-name="Text">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#101828] text-[14px] top-0 w-[108px] whitespace-pre-wrap">Xuất dữ liệu thất bại</p>
    </div>
  );
}
...
function Text27() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[72.594px]" data-name="Text">
...
function Text28() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[99.859px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#101828] text-[14px] whitespace-pre">Theo người tạo</p>
    </div>
  );
}
...
function Text29() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[101.484px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#667085] text-[14px] whitespace-pre">Push, Hệ thống</p>
    </div>
  );
}
...
function TableRow4() {
  return (
    <div className="absolute border-[#d0d5dd] border-[0px_0px_1px] border-solid h-[79px] left-0 top-[237px] w-[1482px]" data-name="Table Row">
      <TableCell27 />
      <TableCell28 />
      <TableCell29 />
      <TableCell30 />
...
function Code4() {
  return (
    <div className="absolute bg-[#f2f4f7] content-stretch flex h-[21px] items-start left-[16px] px-[6px] py-[2px] rounded-[4px] top-[29.5px] w-[142.859px]" data-name="Code">
...
function Text32() {
  return (
    <div className="absolute h-[42px] left-[16px] top-[18.5px] w-[166px]" data-name="Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101828] text-[14px] top-0 w-[135px] whitespace-pre-wrap">Truy vấn audit quan trọng</p>
    </div>
  );
}
...
function Text34() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[143.906px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#667085] text-[14px] whitespace-pre">Quản trị, Giám đốc, IT</p>
    </div>
  );
}
...
function TableRow5() {
  return (
    <div className="absolute border-[#d0d5dd] border-[0px_0px_1px] border-solid h-[79px] left-0 top-[316px] w-[1482px]" data-name="Table Row">
      <TableCell36 />
      <TableCell37 />
      <TableCell38 />
      <TableCell39 />
...
function Code5() {
  return (
    <div className="absolute bg-[#f2f4f7] content-stretch flex h-[21px] items-start left-[16px] px-[6px] py-[2px] rounded-[4px] top-[29.5px] w-[127.469px]" data-name="Code">
...
function Text39() {
  return (
    <div className="absolute h-[42px] left-[16px] top-[18.5px] w-[166px]" data-name="Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101828] text-[14px] top-0 w-[129px] whitespace-pre-wrap">Cảnh báo SLA mức trung bình</p>
    </div>
  );
}
...
function Text41() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[127.25px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#667085] text-[14px] whitespace-pre">Giám sát, Phân tích</p>
    </div>
  );
}
...
function Text42() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[79.875px]" data-name="Text">
...
function Text43() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[32.891px]" data-name="Text">
...
function TableRow6() {
  return (
    <div className="absolute border-[#d0d5dd] border-[0px_0px_1px] border-solid h-[79px] left-0 top-[395px] w-[1482px]" data-name="Table Row">
      <TableCell45 />
      <TableCell46 />
      <TableCell47 />
      <TableCell48 />
...
function Code6() {
  return (
    <div className="absolute bg-[#f2f4f7] content-stretch flex h-[21px] items-start left-[16px] px-[6px] py-[2px] rounded-[4px] top-[29.5px] w-[165.953px]" data-name="Code">
...
function Text46() {
  return (
    <div className="absolute h-[42px] left-[16px] top-[18.5px] w-[166px]" data-name="Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101828] text-[14px] top-0 w-[139px] whitespace-pre-wrap">Cập nhật dữ liệu cấp tỉnh</p>
    </div>
  );
}
...
function Text48() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[132.375px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#667085] text-[14px] whitespace-pre">Giám đốc, Phân tích</p>
    </div>
  );
}
...
function Text49() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[55.125px]" data-name="Text">
...
function Text50() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[103.906px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#667085] text-[14px] whitespace-pre">Email, Hệ thống</p>
    </div>
  );
}
...
function Text52() {
  return (
    <div className="absolute bg-[#e3f2fd] h-[29px] left-[16px] rounded-[8px] top-[25px] w-[47.75px]" data-name="Text">
...
function TableRow7() {
  return (
    <div className="absolute border-[#d0d5dd] border-[0px_0px_1px] border-solid h-[79px] left-0 top-[474px] w-[1482px]" data-name="Table Row">
      <TableCell54 />
      <TableCell55 />
      <TableCell56 />
      <TableCell57 />
...
function Text53() {
  return (
    <div className="absolute h-[21px] left-[16px] top-[29px] w-[147.609px]" data-name="Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101828] text-[14px] top-0 whitespace-pre">Xuất audit log thất bại</p>
    </div>
  );
}
...
function Text55() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[143.438px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#667085] text-[14px] whitespace-pre">IT, Quản trị, Giám đốc</p>
    </div>
  );
}
...
function TableRow8() {
  return (
    <div className="absolute border-[#d0d5dd] border-[0px_0px_1px] border-solid h-[79px] left-0 top-[553px] w-[1482px]" data-name="Table Row">
      <TableCell63 />
      <TableCell64 />
      <TableCell65 />
      <TableCell66 />
...
function Code8() {
  return (
    <div className="absolute bg-[#f2f4f7] content-stretch flex h-[21px] items-start left-[16px] px-[6px] py-[2px] rounded-[4px] top-[29.5px] w-[73.578px]" data-name="Code">
...
function Text60() {
  return (
    <div className="absolute h-[21px] left-[16px] top-[29px] w-[122.719px]" data-name="Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101828] text-[14px] top-0 whitespace-pre">Lead VIP được tạo</p>
    </div>
  );
}
...
function Text62() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[128.578px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#667085] text-[14px] whitespace-pre">Giám đốc, Giám sát</p>
    </div>
  );
}
...
function Icon73() {
  return (
    <div className="absolute left-[10px] size-[13.578px] top-[18px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.5781 13.5781">
        <g clipPath="url(#clip0_2271_1906)" id="Icon">
          <path d={svgPaths.pa035a00} id="Vector" stroke="var(--stroke-0, #667085)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.13151" />
          <path d={svgPaths.p139f4400} id="Vector_2" stroke="var(--stroke-0, #667085)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.13151" />
          <path d={svgPaths.p50bc600} id="Vector_3" stroke="var(--stroke-0, #667085)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.13151" />
        </g>
        <defs>
          <clipPath id="clip0_2271_1906">
            <rect fill="white" height="13.5781" width="13.5781" />
          </clipPath>
        </defs>
      </svg>
    </div>
...
function Text65() {
  return (
    <div className="absolute bg-[#f2f4f7] h-[50px] left-[16px] rounded-[8px] top-[14.5px] w-[88px]" data-name="Text">
      <Icon73 />
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[21px] left-[29.58px] not-italic text-[#667085] text-[14px] top-[4px] w-[29px] whitespace-pre-wrap">Vô hiệu</p>
    </div>
  );
}
...
function TableRow9() {
  return (
    <div className="absolute border-[#d0d5dd] border-[0px_0px_1px] border-solid h-[79px] left-0 top-[632px] w-[1482px]" data-name="Table Row">
      <TableCell72 />
      <TableCell73 />
      <TableCell74 />
      <TableCell75 />
...
function Code9() {
  return (
    <div className="absolute bg-[#f2f4f7] content-stretch flex h-[21px] items-start left-[16px] px-[6px] py-[2px] rounded-[4px] top-[29.5px] w-[104.375px]" data-name="Code">
...
function TableCell81() {
  return (
    <div className="absolute h-[78.5px] left-0 top-0 w-[197.953px]" data-name="Table Cell">
      <Code9 />
    </div>
  );
}
...
function Text67() {
  return (
    <div className="absolute h-[21px] left-[16px] top-[29px] w-[162.375px]" data-name="Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101828] text-[14px] top-0 whitespace-pre">Cảnh báo SLA mức thấp</p>
    </div>
  );
}
...
function TableCell82() {
  return (
    <div className="absolute h-[78.5px] left-[197.95px] top-0 w-[198px]" data-name="Table Cell">
      <Text67 />
    </div>
  );
}
...
function TableCell83() {
  return (
    <div className="absolute h-[78.5px] left-[395.95px] top-0 w-[180px]" data-name="Table Cell">
      <Container40 />
    </div>
  );
}
...
function Text69() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[123.266px]" data-name="Text">
...
function TableCell84() {
  return (
    <div className="absolute h-[78.5px] left-[575.95px] top-0 w-[200px]" data-name="Table Cell">
      <Text69 />
    </div>
  );
}
...
function TableCell85() {
  return (
    <div className="absolute h-[78.5px] left-[775.95px] top-0 w-[140px]" data-name="Table Cell">
      <Text70 />
    </div>
  );
}
...
function Text71() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[16px] top-[31px] w-[60.625px]" data-name="Text">
...
function TableCell86() {
  return (
    <div className="absolute h-[78.5px] left-[915.95px] top-0 w-[140px]" data-name="Table Cell">
      <Text71 />
    </div>
  );
}
  ...
  return (
    <div className="absolute left-[10px] size-[10.391px] top-[18px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.3906 10.3906">
        <g id="Icon">
          <path d={svgPaths.p67ccc00} id="Vector" stroke="var(--stroke-0, #0F9D58)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.865885" />
          <path d={svgPaths.p1509a000} id="Vector_2" stroke="var(--stroke-0, #0F9D58)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.865885" />
        </g>
      </svg>
    </div>
  );
...
function TableCell87() {
  return (
    <div className="absolute h-[78.5px] left-[1055.95px] top-0 w-[120px]" data-name="Table Cell">
      <Text72 />
    </div>
  );
}
...
function TableCell88() {
  return (
    <div className="absolute h-[78.5px] left-[1175.95px] top-0 w-[106.047px]" data-name="Table Cell">
      <Text73 />
    </div>
  );
}
...
function TableRow10() {
  return (
    <div className="absolute h-[78.5px] left-0 top-[711px] w-[1482px]" data-name="Table Row">
      <TableCell81 />
      <TableCell82 />
      <TableCell83 />
      <TableCell84 />
...
function TableBody() {
  return (
    <div className="absolute h-[789.5px] left-0 top-[42.5px] w-[1482px]" data-name="Table Body">
      <TableRow1 />
      <TableRow2 />
      <TableRow3 />
      <TableRow4 />
...
function Table() {
  return (
    <div className="h-[832px] overflow-clip relative shrink-0 w-full" data-name="Table">
      <TableHeader />
      <TableBody />
    </div>
  );
...
function Container42() {
  return (
    <div className="bg-white h-[834px] relative rounded-[8px] shrink-0 w-full" data-name="Container">
...
function NotificationRulesTab() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[1484px]" data-name="NotificationRulesTab">
...
function Container43() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[8px] w-[1486px]" data-name="Container">
...
function AdminPage() {
  return (
    <div className="bg-[#f9fafb] h-[1344.5px] relative shrink-0 w-full" data-name="AdminPage">
...
function MainLayout() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex flex-col h-[1464.5px] items-start left-0 top-0 w-[1534px]" data-name="MainLayout">
      <TopUtilityBar3 />
      <HorizontalNavBar />
      <AdminPage />
    </div>
...
function Dropdown5() {
  return (
    <div className="absolute content-stretch flex flex-col h-[43px] items-start left-0 pb-px pl-[-775px] pr-[1047px] pt-[-473.5px] rounded-[6px] top-[29px] w-[272px]" data-name="Dropdown" style={{ backgroundImage: "linear-gradient(8.98344deg, rgba(0, 0, 0, 0) 50%, rgb(16, 24, 40) 50%), linear-gradient(171.017deg, rgb(16, 24, 40) 50%, rgba(0, 0, 0, 0) 50%), linear-gradient(90deg, rgb(249, 250, 251) 0%, rgb(249, 250, 251) 100%)" }}>
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <Option26 />
      <Option27 />
    </div>
...
function UniversalModal() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.5)] content-stretch flex h-[935px] items-center justify-center left-0 top-[300px] w-[1534px]" data-name="UniversalModal">
      <Form />
    </div>
  );
}
