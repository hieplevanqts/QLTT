...
const ADMIN_MENU_SEED: Array<Omit<MenuItem, "parentId">> = [
  ...
  { id: "admin-catalogs-common", label: "Danh mục dùng chung", path: "/system-admin/master-data/common-catalogs", order: 24, moduleId: "system-admin-master-data", icon: "Folder" },
  { id: "admin-catalogs-domain", label: "Danh mục nghiệp vụ QLTT", path: "/system-admin/master-data/dms-catalogs", order: 25, moduleId: "system-admin-master-data", icon: "Layers" },
  ...
  { id: "admin-assignments", label: "Phân quyền", path: "/system-admin/iam/role-permissions", order: 34, moduleId: "system-admin-iam", icon: "UserCheck" },
