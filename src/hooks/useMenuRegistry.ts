...
const ADMIN_MENU_SEED: Array<Omit<MenuItem, "parentId">> = [
  ...
  { id: "admin-catalogs-domain", label: "Danh mục nghiệp vụ QLTT", path: "/system-admin/master-data/catalogs?group=DMS", order: 25, moduleId: "system-admin-master-data", icon: "Layers" },
