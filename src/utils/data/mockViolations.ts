...
export const mockViolations: ViolationRecord[] = [
  ...
  },
  {
    ...
    detectedBy: 'Chi cục QLTT Phường 1',
    severity: 'moderate',
    status: 'fined',
    fineAmount: 5000000,
  ...
  },
  {
    ...
    detectedBy: 'Chi cục QLTT Phường 2',
    severity: 'minor',
    status: 'resolved',
    fineAmount: 1500000,
  ...
  // Store ID 4 - High violation history
  {
    ...
    detectedBy: 'Chi cục QLTT Phường 4',
    severity: 'severe',
    status: 'processing',
    fineAmount: 25000000,
  ...
  },
  {
    ...
    detectedBy: 'Cảnh sát PCCC - Chi cục QLTT Phường 4',
    severity: 'moderate',
    status: 'fined',
    fineAmount: 7000000,
