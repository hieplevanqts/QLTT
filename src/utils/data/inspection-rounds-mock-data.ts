...
export const mockInspectionRounds: InspectionRound[] = [
  ...
  },
  {
    ...
    endDate: '2026-02-05',
    leadUnit: 'Chi cục QLTT Quận Hoàng Mai',
    team: [],
    teamSize: 0,
    totalTargets: 15,
    inspectedTargets: 0,
  ...
  },
  {
    ...
    planName: 'Kế hoạch kiểm tra xăng dầu Q1/2026 - TP.HCM',
    type: 'targeted',
    status: 'active',
