...
export const mockEvidenceData: Evidence[] = [
  {
    ...
    tags: ['Vệ sinh', 'Vi phạm', 'Phường 1'],
    description: 'Hình ảnh vi phạm vệ sinh tại cơ sở Phường 1',
  },
  {
    id: 'EV-2026-002',
  ...
  },
  {
    ...
    fileSize: '920 KB',
    location: 'Phường 3, Hà Nội',
    tags: ['Biên bản', 'Vi phạm', 'Phường 3'],
    description: 'Biên bản vi phạm tại Phường 3',
  },
];
