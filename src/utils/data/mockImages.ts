...
export const mockStoreImages: StoreImage[] = [
  // Store ID 1 - Multiple images across categories
  {
    ...
    uploadedBy: 'Trần Văn B - Đội QLTT Phường 1',
  ...
  },
  {
    ...
    uploadedBy: 'Lê Thị C - Đội QLTT Phường 1',
  ...
  },
  {
    ...
    uploadedBy: 'Nguyễn Văn A - Đội QLTT Phường 1',
  ...
  // Store ID 2 - Medium number of images
  {
    ...
    uploadedBy: 'Hoàng Thị E - Đội QLTT Phường 2',
  ...
  // Store ID 3 - Few images
  {
    ...
    title: 'Mặt tiền cửa hàng',
    uploadedBy: 'Nguyễn Văn A - Đội QLTT Phường 3',
  ...
  // Store ID 4 - Images showing violations
  {
    ...
    title: 'Biển hiệu cửa hàng',
    uploadedBy: 'Hoàng Thị E - Chi cục QLTT Phường 4',
  ...
  },
  {
    ...
    uploadedBy: 'Lê Văn F - Đội QLTT Phường 4',
  ...
  },
  {
    ...
    title: 'Giấy tờ thiếu',
    uploadedBy: 'Trần Văn B - Đội QLTT Phường 4',
  ...
  },
  {
    ...
    uploadedBy: 'Nguyễn Văn D - PCCC Phường 4',
