import svgPaths from "./svg-ixhhkeeay3";
...
function Heading2() {
  return (
    <div className="flex-[1_0_0] h-[24px] min-h-px min-w-px relative" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px]">Thêm địa bàn mới</p>
      </div>
    </div>
  );
}
...
function Container42() {
  return (
    <div className="h-[24px] relative shrink-0 w-[157.109px]" data-name="Container">
...
function Label() {
  return (
    <div className="h-[24px] relative shrink-0 w-[800px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <p className="css-ew64yg font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[#101828] text-[16px]">Mã</p>
      </div>
    </div>
  );
}
...
function TextInput2() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[4px] w-[800px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-[rgba(16,24,40,0.5)]">VD: DB001</p>
      </div>
    </div>
  );
}
...
function Container44() {
  return (
    <div className="h-[48px] relative shrink-0 w-[800px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Label />
        <TextInput2 />
      </div>
...
function TextInput3() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[4px] w-[800px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-[rgba(16,24,40,0.5)]">Nhập tên địa bàn</p>
      </div>
    </div>
  );
}
...
function Dropdown2() {
  return (
    <div className="h-[22px] relative rounded-[4px] shrink-0 w-[800px]" data-name="Dropdown">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-0 pl-[-335.5px] pr-[1135.5px] pt-[-329.5px] relative size-full">
        <Option6 />
        <Option7 />
        <Option8 />
      </div>
...
function Container46() {
  return (
    <div className="h-[46px] relative shrink-0 w-[800px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Label2 />
        <Dropdown2 />
      </div>
...
function Dropdown3() {
  return (
    <div className="h-[22px] relative rounded-[4px] shrink-0 w-[800px]" data-name="Dropdown">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-0 pl-[-335.5px] pr-[1135.5px] pt-[-375.5px] relative size-full">
        <Option9 />
        <Option10 />
      </div>
    </div>
...
function Dropdown4() {
  return (
    <div className="h-[22px] relative rounded-[4px] shrink-0 w-[800px]" data-name="Dropdown">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-0 pl-[-335.5px] pr-[1135.5px] pt-[-421.5px] relative size-full">
        <Option11 />
        <Option12 />
        <Option13 />
        <Option14 />
...
function Option46() {
  return (
    <div className="h-0 relative shrink-0 w-full" data-name="Option">
      <p className="absolute css-4hzbpn font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic text-[#aaa] text-[16px] top-0 w-0">-- Chọn Xã/Phường --</p>
    </div>
  );
}
...
function Dropdown5() {
  return (
    <div className="h-[22px] opacity-60 relative rounded-[4px] shrink-0 w-[800px]" data-name="Dropdown">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-0 pl-[-335.5px] pr-[1135.5px] pt-[-467.5px] relative size-full">
        <Option46 />
      </div>
    </div>
  );
...
function Icon58() {
  return (
    <div className="absolute left-0 size-[14px] top-[5px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_2482_4668)" id="Icon">
          <path d={svgPaths.pc012c00} id="Vector" stroke="var(--stroke-0, #101828)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          <path d="M7 4.66667V7" id="Vector_2" stroke="var(--stroke-0, #101828)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          <path d="M7 9.33333H7.00583" id="Vector_3" stroke="var(--stroke-0, #101828)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
        </g>
        <defs>
          <clipPath id="clip0_2482_4668">
...
function Container49() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[800px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon58 />
        <p className="absolute css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[14px] not-italic text-[#101828] text-[16px] top-[-1px]">Vui lòng chọn Tỉnh/Thành phố trước</p>
      </div>
    </div>
  );
}
...
function Container50() {
  return (
    <div className="h-[70px] relative shrink-0 w-[800px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Label5 />
        <Dropdown5 />
        <Container49 />
...
function Container52() {
  return (
    <div className="content-stretch flex flex-col h-[428px] items-start relative shrink-0 w-full" data-name="Container">
      <Container44 />
      <Container45 />
      <Container46 />
      <Container47 />
...
function AreaModal() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.5)] content-stretch flex flex-col h-[476px] items-start left-[335.5px] rounded-[6px] top-[496.5px] w-[800px]" data-name="AreaModal">
      <Container43 />
      <Form />
    </div>
  );
