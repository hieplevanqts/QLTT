import svgPaths from "./svg-31y360kh9k";
...
function Text6() {
  return (
    <div className="absolute h-[20px] left-[104px] overflow-clip top-[22px] w-[244.203px]" data-name="Text">
      <p className="absolute css-ew64yg font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#101828] text-[14px] top-0">Chi cục quản lý thị trường Hải Phòng</p>
    </div>
  );
}
...
function BoldText() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[61.98px] top-[2px] w-[8.578px]" data-name="Bold Text">
      <p className="css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#101828] text-[14px]">5</p>
    </div>
  );
}
  ...
  return (
    <div className="flex-[1_0_0] h-[21px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        ...
        <BoldText />
        <p className="absolute css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-[70.56px] not-italic text-[#667085] text-[14px] top-0">đơn vị</p>
      </div>
    </div>
  );
}
...
function Container27() {
  return (
    <div className="h-[21px] relative shrink-0 w-[138.906px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Icon47 />
        <Text7 />
      </div>
...
function Container28() {
  return (
    <div className="bg-white h-[55px] relative rounded-[8px] shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_1px_3px_0px_rgba(16,24,40,0.1),0px_1px_2px_0px_rgba(16,24,40,0.06)]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pl-[21px] pr-[1194.094px] py-px relative size-full">
          <Container27 />
        </div>
      </div>
    </div>
...
function Heading1() {
  return (
    <div className="flex-[1_0_0] h-[54px] min-h-px min-w-px relative" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-4hzbpn font-['Inter:Bold',sans-serif] font-bold leading-[27px] left-0 not-italic text-[#101828] text-[18px] top-px w-[450px]">{`Thêm đơn vị con của "Chi cục quản lý thị trường Hà Nội"`}</p>
      </div>
    </div>
  );
}
...
function Icon50() {
  return (
    <div className="absolute left-[16px] size-[16px] top-[18px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_2341_4987)" id="Icon">
          ...
          <path d="M8 5.33333V8" id="Vector_2" stroke="var(--stroke-0, #2563EB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M8 10.6667H8.00667" id="Vector_3" stroke="var(--stroke-0, #2563EB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
        <defs>
          <clipPath id="clip0_2341_4987">
            <rect fill="white" height="16" width="16" />
          </clipPath>
        </defs>
      </svg>
...
function BoldText1() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-0 top-[4px] w-[75.75px]" data-name="Bold Text">
      <p className="css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#1e40af] text-[14px]">Đơn vị cha:</p>
    </div>
  );
}
...
function BoldText2() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-0 top-[28px] w-[32.609px]" data-name="Bold Text">
      <p className="css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#1e40af] text-[14px]">Loại:</p>
    </div>
  );
}
...
function BoldText3() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[118.66px] top-[28px] w-[60.906px]" data-name="Bold Text">
      <p className="css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#1e40af] text-[14px]">Loại mới:</p>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="absolute h-[48px] left-[44px] top-[16px] w-[384.453px]" data-name="Container">
      <BoldText1 />
      <p className="absolute css-4hzbpn font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[75.75px] not-italic text-[#1e40af] text-[16px] top-[-1px] w-[309px]">Chi cục quản lý thị trường Hà Nội (QT01)</p>
      <BoldText2 />
      <p className="absolute css-4hzbpn font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[32.61px] not-italic text-[#1e40af] text-[16px] top-[23px] w-[87px]">Chi cục →</p>
      <BoldText3 />
      <p className="absolute css-4hzbpn font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[179.56px] not-italic text-[#1e40af] text-[16px] top-[23px] w-[30px]">Đội</p>
    </div>
  );
}
...
function Container32() {
  return (
    <div className="absolute bg-[rgba(59,130,246,0.1)] border border-[rgba(59,130,246,0.3)] border-solid h-[82px] left-[20px] rounded-[6px] top-[20px] w-[560px]" data-name="Container">
      <Icon50 />
      <Container31 />
    </div>
  );
...
function TextInput2() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[6px] w-[560px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[14px] py-[9px] relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(16,24,40,0.5)]">Nhập tên đơn vị</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
...
function Container33() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[78px] items-start left-[20px] top-[134px] w-[560px]" data-name="Container">
      <Label />
      <TextInput2 />
    </div>
  );
...
function TextInput3() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[6px] w-[560px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[14px] py-[9px] relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(16,24,40,0.5)]">Nhập mã đơn vị (ví dụ: DV001)</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
...
function Container34() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[78px] items-start left-[20px] top-[228px] w-[560px]" data-name="Container">
      <Label1 />
      <TextInput3 />
    </div>
  );
...
function Label2() {
  return (
    <div className="absolute content-stretch flex h-[21px] items-center left-0 top-0 w-[560px]" data-name="Label">
...
function Small() {
  return (
    <div className="absolute h-[18px] left-0 top-[88px] w-[560px]" data-name="Small">
...
function Dropdown() {
  return (
    <div className="absolute content-stretch flex flex-col h-[43px] items-start left-0 pb-px pl-[-422px] pr-[982px] pt-[-505px] rounded-[6px] top-[37px] w-[560px]" data-name="Dropdown" style={{ backgroundImage: "linear-gradient(4.39088deg, rgba(0, 0, 0, 0) 50%, rgb(16, 24, 40) 50%), linear-gradient(175.609deg, rgb(16, 24, 40) 50%, rgba(0, 0, 0, 0) 50%), linear-gradient(90deg, rgb(249, 250, 251) 0%, rgb(249, 250, 251) 100%)" }}>
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <Option />
      <Option1 />
      <Option2 />
...
function Container35() {
  return (
    <div className="absolute h-[106px] left-[20px] top-[322px] w-[560px]" data-name="Container">
      <Label2 />
      <Small />
      <Dropdown />
    </div>
...
function Label3() {
  return (
    <div className="absolute h-[21px] left-0 top-0 w-[560px]" data-name="Label">
      <Icon51 />
      <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-[26px] not-italic text-[#101828] text-[14px] top-0">Địa bàn quản lý</p>
    </div>
  );
}
...
function Small1() {
  return (
    <div className="absolute h-[18px] left-0 top-[92px] w-[560px]" data-name="Small">
      <p className="absolute css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#667085] text-[12px] top-0">Chọn các địa bàn mà đơn vị này quản lý</p>
    </div>
  );
}
...
function TextInput4() {
  return (
    <div className="absolute bg-white h-[47px] left-0 rounded-[6px] top-0 w-[560px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip pl-[40px] pr-[12px] py-[12px] relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#667085] text-[14px]">Địa bàn mẫu</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#cdd3dc] border-solid inset-0 pointer-events-none rounded-[6px] shadow-[0px_0px_0px_0.049px_rgba(0,92,182,0)]" />
    </div>
  );
}
...
function Container37() {
  return (
    <div className="h-[56px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[279.53px] not-italic text-[#667085] text-[16px] text-center top-[15px] translate-x-[-50%]">Không tìm thấy địa bàn</p>
    </div>
  );
}
...
function Container38() {
  return (
    <div className="bg-white h-[58px] relative rounded-[6px] shrink-0 w-full" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start p-px relative size-full">
          <Container37 />
        </div>
...
function Container39() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] h-[47px] items-start left-0 top-[37px] w-[560px]" data-name="Container">
      <Container36 />
      <Container38 />
    </div>
  );
...
function Container40() {
  return (
    <div className="absolute h-[110px] left-[20px] top-[444px] w-[560px]" data-name="Container">
      <Label3 />
      <Small1 />
      <Container39 />
    </div>
...
function Container41() {
  return (
    <div className="h-[574px] relative shrink-0 w-full" data-name="Container">
      <Container32 />
      <Container33 />
      <Container34 />
      <Container35 />
...
function Button48() {
  return (
    <div className="absolute bg-[#005cb6] h-[43px] left-[453.66px] rounded-[6px] top-[21px] w-[126.344px]" data-name="Button">
      <Icon53 />
      <p className="absolute css-ew64yg font-['Inter:Medium',sans-serif] font-medium leading-[21px] left-[75.5px] not-italic text-[14px] text-center text-white top-[11px] translate-x-[-50%]">Thêm mới</p>
    </div>
  );
}
...
function Button49() {
  return (
    <div className="absolute bg-white content-stretch flex h-[43px] items-center left-[376.75px] px-[19px] py-[11px] rounded-[6px] top-[21px] w-[64.906px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
...
function Form() {
  return (
    <div className="bg-white h-[753px] relative rounded-[8px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1)] shrink-0 w-[600px]" data-name="Form">
