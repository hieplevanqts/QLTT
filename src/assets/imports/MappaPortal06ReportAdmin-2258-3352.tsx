import svgPaths from "./svg-k8xzb7roi1";
...
function HeaderCell1() {
  return (
    <div className="absolute h-[42.5px] left-[60px] top-0 w-[146.422px]" data-name="Header Cell">
...
function HeaderCell2() {
  return (
    <div className="absolute h-[42.5px] left-[206.42px] top-0 w-[313.234px]" data-name="Header Cell">
...
function HeaderCell3() {
  return (
    <div className="absolute h-[42.5px] left-[519.66px] top-0 w-[522.344px]" data-name="Header Cell">
...
function Text4() {
  return (
    <div className="absolute bg-[#f2f4f7] content-stretch flex h-[26px] items-start left-[16px] px-[11px] py-[5px] rounded-[6px] top-[27px] w-[114.422px]" data-name="Text">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
...
function TableCell1() {
  return (
    <div className="absolute h-[79px] left-[60px] top-0 w-[146.422px]" data-name="Table Cell">
      <Text4 />
    </div>
  );
}
...
function TableCell2() {
  return (
    <div className="absolute h-[79px] left-[206.42px] top-0 w-[313.234px]" data-name="Table Cell">
      <Text5 />
    </div>
  );
}
...
function TableCell3() {
  return (
    <div className="absolute h-[79px] left-[519.66px] top-0 w-[522.344px]" data-name="Table Cell">
      <Text6 />
    </div>
  );
}
...
function Text9() {
  return (
    <div className="absolute bg-[#f2f4f7] content-stretch flex h-[26px] items-start left-[16px] px-[11px] py-[5px] rounded-[6px] top-[27px] w-[97.625px]" data-name="Text">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
...
function TableCell15() {
  return (
    <div className="absolute h-[78.5px] left-[60px] top-0 w-[146.422px]" data-name="Table Cell">
      <Text14 />
    </div>
  );
}
...
function TableCell16() {
  return (
    <div className="absolute h-[78.5px] left-[206.42px] top-0 w-[313.234px]" data-name="Table Cell">
      <Text15 />
    </div>
  );
}
...
function TableCell17() {
  return (
    <div className="absolute h-[78.5px] left-[519.66px] top-0 w-[522.344px]" data-name="Table Cell">
      <Text16 />
    </div>
  );
}
...
function MainLayout() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex flex-col h-[1070px] items-start left-0 top-0 w-[1534px]" data-name="MainLayout">
      <TopUtilityBar3 />
      <HorizontalNavBar />
      <AdminPage />
    </div>
...
function Paragraph1() {
  return (
    <div className="h-[51.188px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[25.6px] left-0 not-italic text-[#101828] text-[16px] top-[-2px] w-[868px] whitespace-pre-wrap">Biểu mẫu kiểm tra nghiệp vụ cho chuyên đề kiểm tra cơ sở kinh doanh hàng giả, hàng nhái, hàng vi phạm quyền sở hữu trí tuệ</p>
    </div>
  );
}
...
function Container19() {
  return (
    <div className="absolute content-stretch flex flex-col h-[51.188px] items-start left-0 pl-[4px] pr-0 py-0 rounded-[6px] top-[95px] w-[900px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#005cb6] border-[0px_0px_0px_4px] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <Paragraph1 />
    </div>
  );
}
...
function Button43() {
  return (
    <div className="absolute bg-white border border-[#d0d5dd] border-solid h-[43px] left-0 rounded-[6px] top-0 w-[158.875px]" data-name="Button">
      <Icon49 />
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[21px] left-[90px] not-italic text-[#101828] text-[14px] text-center top-[10px] translate-x-[-50%] whitespace-pre">Mở rộng tất cả</p>
    </div>
  );
}
...
function Icon50() {
  return (
    <div className="absolute left-[18px] size-[16px] top-[12.5px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d="M12 10L8 6L4 10" id="Vector" stroke="var(--stroke-0, #101828)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Button44() {
  return (
    <div className="absolute bg-white border border-[#d0d5dd] border-solid h-[43px] left-[158.88px] rounded-[6px] top-0 w-[158.25px]" data-name="Button">
      <Icon50 />
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[21px] left-[90.5px] not-italic text-[#101828] text-[14px] text-center top-[10px] translate-x-[-50%] whitespace-pre">Thu gọn tất cả</p>
    </div>
  );
}
...
function Button45() {
  return (
    <div className="absolute bg-white border border-[#d0d5dd] border-solid h-[43px] left-[317.13px] rounded-[6px] top-0 w-[132.453px]" data-name="Button">
      <Icon51 />
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[21px] left-[77.5px] not-italic text-[#101828] text-[14px] text-center top-[10px] translate-x-[-50%] whitespace-pre">Xuất Excel</p>
    </div>
  );
}
...
function Container20() {
  return (
    <div className="absolute h-[43px] left-[400px] top-0 w-[449.578px]" data-name="Container">
      <Button43 />
      <Button44 />
      <Button45 />
    </div>
...
function TextInput2() {
  return (
    <div className="absolute bg-[#f9fafb] h-[43px] left-0 rounded-[6px] top-0 w-[400px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip pl-[42px] pr-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#667085] text-[14px] whitespace-pre">Tìm kiếm tiêu chí...</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
...
function Container22() {
  return (
    <div className="absolute h-[43px] left-0 top-[146.19px] w-[900px]" data-name="Container">
      <Container20 />
      <Container21 />
    </div>
  );
...
function Text20() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-white whitespace-pre">1</p>
      </div>
    </div>
  );
}
...
function BoldText3() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[209.188px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Xác nhận địa điểm kiểm tra</p>
    </div>
  );
}
...
function Code() {
  return (
    <div className="absolute h-[24px] left-[209.19px] rounded-[4px] top-0 w-[67.219px]" data-name="Code">
      <p className="absolute font-['Courier_New:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-0 whitespace-pre">STEP_01</p>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] w-[749px] whitespace-pre-wrap">Xác nhận cán bộ đã đến đúng địa chỉ cơ sở cần kiểm tra theo kế hoạch. Đối chiếu với GPS và thông tin hồ sơ.</p>
    </div>
  );
}
...
function Text21() {
  return (
    <div className="bg-[#fee] flex-[1_0_0] h-[24px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#d32f2f] text-[16px] top-[-1px] tracking-[0.5px] uppercase whitespace-pre">BẮT BUỘC</p>
      </div>
    </div>
  );
}
...
function Icon53() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d="M5 7.5L10 12.5L15 7.5" id="Vector" stroke="var(--stroke-0, #101828)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Container26() {
  return (
    <div className="h-[24px] relative shrink-0 w-[107.188px]" data-name="Container">
...
function Button46() {
  return (
    <div className="content-stretch flex h-[72px] items-start justify-between relative shrink-0 w-full" data-name="Button">
      <Container25 />
      <Container26 />
    </div>
  );
...
function Container27() {
  return (
    <div className="h-[46.094px] relative rounded-[8px] shrink-0 w-[900px]" data-name="Container">
...
function Text22() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-white whitespace-pre">2</p>
      </div>
    </div>
  );
}
...
function BoldText4() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[195.656px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Chụp ảnh biển hiệu cơ sở</p>
    </div>
  );
}
...
function Code1() {
  return (
    <div className="absolute h-[24px] left-[195.66px] rounded-[4px] top-0 w-[67.219px]" data-name="Code">
      <p className="absolute font-['Courier_New:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-0 whitespace-pre">STEP_02</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] w-[742px] whitespace-pre-wrap">Chụp ảnh biển hiệu, bảng tên của cơ sở kinh doanh từ ít nhất 2 góc độ khác nhau. Đảm bảo ảnh rõ nét, đầy đủ ánh sáng.</p>
    </div>
  );
}
...
function Text24() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-white whitespace-pre">3</p>
      </div>
    </div>
  );
}
...
function BoldText5() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[203px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Chụp ảnh tổng quan cơ sở</p>
    </div>
  );
}
...
function Code2() {
  return (
    <div className="absolute h-[24px] left-[203px] rounded-[4px] top-0 w-[67.219px]" data-name="Code">
      <p className="absolute font-['Courier_New:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-0 whitespace-pre">STEP_03</p>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] w-[734px] whitespace-pre-wrap">Chụp ảnh tổng quan bên ngoài và bên trong cơ sở, bao gồm mặt tiền, khu vực bày bán hàng hóa, kho chứa (nếu có).</p>
    </div>
  );
}
...
function Text26() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-white whitespace-pre">4</p>
      </div>
    </div>
  );
}
...
function BoldText6() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[257.469px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Gặp gỡ chủ cơ sở / người đại diện</p>
    </div>
  );
}
...
function Code3() {
  return (
    <div className="absolute h-[24px] left-[257.47px] rounded-[4px] top-0 w-[67.219px]" data-name="Code">
      <p className="absolute font-['Courier_New:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-0 whitespace-pre">STEP_04</p>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Xác nhận đã gặp chủ cơ sở hoặc người được ủy quyền đại diện hợp pháp. Ghi nhận thông tin liên hệ.</p>
    </div>
  );
}
...
function Container39() {
  return (
    <div className="h-[48px] relative shrink-0 w-[757px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Container38 />
        <Paragraph5 />
      </div>
...
function Button49() {
  return (
    <div className="content-stretch flex h-[48px] items-start justify-between relative shrink-0 w-full" data-name="Button">
      <Container40 />
      <Container41 />
    </div>
  );
...
function Container42() {
  return (
    <div className="h-[30.734px] relative rounded-[8px] shrink-0 w-[900px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
        <Button49 />
      </div>
    </div>
...
function Text28() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-white whitespace-pre">5</p>
      </div>
    </div>
  );
}
...
function BoldText7() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[188.219px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Thông tin người đại diện</p>
    </div>
  );
}
...
function Code4() {
  return (
    <div className="absolute h-[24px] left-[188.22px] rounded-[4px] top-0 w-[67.219px]" data-name="Code">
      <p className="absolute font-['Courier_New:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-0 whitespace-pre">STEP_05</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Nhập họ tên, số CMND/CCCD, số điện thoại của người đại diện cơ sở. Chụp ảnh giấy tờ tùy thân.</p>
    </div>
  );
}
...
function Container44() {
  return (
    <div className="h-[48px] relative shrink-0 w-[727.156px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Container43 />
        <Paragraph6 />
      </div>
...
function Text30() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-white whitespace-pre">6</p>
      </div>
    </div>
  );
}
...
function BoldText8() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[238.219px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Kiểm tra Giấy phép kinh doanh</p>
    </div>
  );
}
...
function Code5() {
  return (
    <div className="absolute h-[24px] left-[238.22px] rounded-[4px] top-0 w-[67.219px]" data-name="Code">
      <p className="absolute font-['Courier_New:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-0 whitespace-pre">STEP_06</p>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] w-[718px] whitespace-pre-wrap">Kiểm tra Giấy chứng nhận đăng ký kinh doanh hoặc Giấy phép kinh doanh có điều kiện (nếu áp dụng). Chụp ảnh giấy phép.</p>
    </div>
  );
}
...
function Text32() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-white whitespace-pre">7</p>
      </div>
    </div>
  );
}
...
function BoldText9() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[261.375px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Upload ảnh Giấy phép kinh doanh</p>
    </div>
  );
}
...
function Code6() {
  return (
    <div className="absolute h-[24px] left-[261.38px] rounded-[4px] top-0 w-[67.219px]" data-name="Code">
      <p className="absolute font-['Courier_New:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-0 whitespace-pre">STEP_07</p>
    </div>
  );
}
...
function Paragraph8() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Upload ảnh hoặc file scan Giấy phép kinh doanh (nếu có). File định dạng JPG, PNG hoặc PDF.</p>
    </div>
  );
}
...
function Container54() {
  return (
    <div className="h-[48px] relative shrink-0 w-[708.859px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Container53 />
        <Paragraph8 />
      </div>
...
function Text33() {
  return (
    <div className="bg-[#e3f2fd] flex-[1_0_0] h-[24px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#1976d2] text-[16px] top-[-1px] tracking-[0.5px] uppercase whitespace-pre">TÙY CHỌN</p>
      </div>
    </div>
  );
}
...
function Container56() {
  return (
    <div className="h-[24px] relative shrink-0 w-[109.953px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <Text33 />
        <Icon59 />
      </div>
...
function Text34() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-white whitespace-pre">8</p>
      </div>
    </div>
  );
}
...
function BoldText10() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[248.688px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Danh sách hàng hóa kinh doanh</p>
    </div>
  );
}
...
function Code7() {
  return (
    <div className="absolute h-[24px] left-[248.69px] rounded-[4px] top-0 w-[67.219px]" data-name="Code">
      <p className="absolute font-['Courier_New:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-0 whitespace-pre">STEP_08</p>
    </div>
  );
}
...
function Paragraph9() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] w-[728px] whitespace-pre-wrap">Liệt kê các nhóm hàng hóa chính mà cơ sở đang kinh doanh (ví dụ: quần áo, giày dép, mỹ phẩm, điện tử...).</p>
    </div>
  );
}
...
function Text36() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-white whitespace-pre">9</p>
      </div>
    </div>
  );
}
...
function BoldText11() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[215.5px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Phát hiện hàng nghi ngờ giả</p>
    </div>
  );
}
...
function Code8() {
  return (
    <div className="absolute h-[24px] left-[215.5px] rounded-[4px] top-0 w-[67.219px]" data-name="Code">
      <p className="absolute font-['Courier_New:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-0 whitespace-pre">STEP_09</p>
    </div>
  );
}
...
function Paragraph10() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] w-[725px] whitespace-pre-wrap">Cán bộ có phát hiện hàng hóa nghi ngờ giả, hàng nhái, hàng xâm phạm quyền sở hữu trí tuệ hay không?</p>
    </div>
  );
}
...
function Text38() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-white whitespace-pre">10</p>
      </div>
    </div>
  );
}
...
function BoldText12() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[217.281px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Chụp ảnh hàng nghi ngờ giả</p>
    </div>
  );
}
...
function Code9() {
  return (
    <div className="absolute h-[24px] left-[217.28px] rounded-[4px] top-0 w-[67.219px]" data-name="Code">
      <p className="absolute font-['Courier_New:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-0 whitespace-pre">STEP_10</p>
    </div>
  );
}
...
function Paragraph11() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] w-[737px] whitespace-pre-wrap">Nếu phát hiện hàng nghi ngờ, chụp ảnh chi tiết sản phẩm, tem nhãn, logo, bao bì. Chụp cả góc độ tổng thể và cận cảnh.</p>
    </div>
  );
}
...
function Text40() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-white whitespace-pre">11</p>
      </div>
    </div>
  );
}
...
function BoldText13() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[215.453px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Mô tả chi tiết hàng nghi ngờ</p>
    </div>
  );
}
...
function Code10() {
  return (
    <div className="absolute h-[24px] left-[215.45px] rounded-[4px] top-0 w-[67.219px]" data-name="Code">
      <p className="absolute font-['Courier_New:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-0 whitespace-pre">STEP_11</p>
    </div>
  );
}
...
function Paragraph12() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] w-[746px] whitespace-pre-wrap">Mô tả chi tiết về hàng hóa nghi ngờ: tên sản phẩm, nhãn hiệu, xuất xứ ghi trên bao bì, số lượng ước tính, giá bán.</p>
    </div>
  );
}
...
function Text42() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-white whitespace-pre">12</p>
      </div>
    </div>
  );
}
...
function BoldText14() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[161.578px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Lập biên bản tạm giữ</p>
    </div>
  );
}
...
function Code11() {
  return (
    <div className="absolute h-[24px] left-[161.58px] rounded-[4px] top-0 w-[67.219px]" data-name="Code">
      <p className="absolute font-['Courier_New:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-0 whitespace-pre">STEP_12</p>
    </div>
  );
}
...
function Paragraph13() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Cán bộ có lập biên bản tạm giữ hàng hóa vi phạm hay không?</p>
    </div>
  );
}
...
function Container79() {
  return (
    <div className="h-[48px] relative shrink-0 w-[465.453px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Container78 />
        <Paragraph13 />
      </div>
...
function Text44() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-white whitespace-pre">13</p>
      </div>
    </div>
  );
}
...
function BoldText15() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[188.641px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Upload biên bản tạm giữ</p>
    </div>
  );
}
...
function Code12() {
  return (
    <div className="absolute h-[24px] left-[188.64px] rounded-[4px] top-0 w-[67.219px]" data-name="Code">
      <p className="absolute font-['Courier_New:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-0 whitespace-pre">STEP_13</p>
    </div>
  );
}
...
function Paragraph14() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Upload file scan hoặc ảnh biên bản tạm giữ (nếu có). Đảm bảo chữ ký và đóng dấu rõ ràng.</p>
    </div>
  );
}
...
function Container84() {
  return (
    <div className="h-[48px] relative shrink-0 w-[687.922px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Container83 />
        <Paragraph14 />
      </div>
...
function Text46() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-white whitespace-pre">14</p>
      </div>
    </div>
  );
}
...
function BoldText16() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[131.016px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Kết luận kiểm tra</p>
    </div>
  );
}
...
function Code13() {
  return (
    <div className="absolute h-[24px] left-[131.02px] rounded-[4px] top-0 w-[67.219px]" data-name="Code">
      <p className="absolute font-['Courier_New:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-0 whitespace-pre">STEP_14</p>
    </div>
  );
}
...
function Paragraph15() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Nhận xét tổng quan về tình trạng cơ sở, mức độ tuân thủ pháp luật, đề xuất biện pháp xử lý (nếu có).</p>
    </div>
  );
}
...
function Container89() {
  return (
    <div className="h-[48px] relative shrink-0 w-[757.484px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Container88 />
        <Paragraph15 />
      </div>
...
function Text48() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-white whitespace-pre">15</p>
      </div>
    </div>
  );
}
...
function BoldText17() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[129.891px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Chữ ký xác nhận</p>
    </div>
  );
}
...
function Code14() {
  return (
    <div className="absolute h-[24px] left-[129.89px] rounded-[4px] top-0 w-[67.219px]" data-name="Code">
      <p className="absolute font-['Courier_New:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-0 whitespace-pre">STEP_15</p>
    </div>
  );
}
...
function Paragraph16() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Chữ ký điện tử của cán bộ thực hiện kiểm tra để xác nhận tính xác thực của thông tin đã nhập.</p>
    </div>
  );
}
...
function Container94() {
  return (
    <div className="h-[48px] relative shrink-0 w-[710.516px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Container93 />
        <Paragraph16 />
      </div>
...
function Container98() {
  return (
    <div className="absolute content-stretch flex flex-col h-[583.813px] items-start left-0 overflow-clip top-[189.19px] w-[900px]" data-name="Container">
      <Container27 />
      <Container32 />
      <Container37 />
      <Container42 />
...
function Container99() {
  return (
    <div className="h-[41px] relative shrink-0 w-[168.266px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] w-[169px] whitespace-pre-wrap">Hiển thị 15 / 15 tiêu chí</p>
      </div>
    </div>
  );
}
...
function Button61() {
  return (
    <div className="bg-[#005cb6] h-[41px] relative rounded-[6px] shrink-0 w-[71.969px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[18px] py-[10px] relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-pre">Đóng</p>
      </div>
    </div>
  );
}
...
function Container100() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[82px] items-start justify-end left-0 pb-0 pl-0 pr-[20px] pt-[21px] top-[773px] w-[900px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#d0d5dd] border-[1px_0px_0px] border-solid inset-0 pointer-events-none" />
      <Container99 />
      <Button61 />
    </div>
...
function Icon68() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p3713e00} id="Vector" stroke="var(--stroke-0, #101828)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          ...
          <path d="M8.33333 7.5H6.66667" id="Vector_3" stroke="var(--stroke-0, #101828)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M13.3333 10.8333H6.66667" id="Vector_4" stroke="var(--stroke-0, #101828)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M13.3333 14.1667H6.66667" id="Vector_5" stroke="var(--stroke-0, #101828)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Heading1() {
  return (
    <div className="h-[27px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[27px] left-0 not-italic text-[#101828] text-[18px] top-px whitespace-pre">Kiểm tra Cơ sở Kinh doanh Hàng giả</p>
    </div>
  );
}
...
function Code15() {
  return (
    <div className="absolute h-[27px] left-0 rounded-[4px] top-0 w-[118.828px]" data-name="Code">
      <p className="absolute font-['Courier_New:Bold',sans-serif] leading-[27px] left-0 not-italic text-[#005cb6] text-[18px] top-0 whitespace-pre">KT_HANG_GIA</p>
    </div>
  );
}
...
function Paragraph17() {
  return (
    <div className="h-[27px] relative shrink-0 w-full" data-name="Paragraph">
      <Code15 />
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[27px] left-[118.83px] not-italic text-[#101828] text-[18px] top-px w-[101px] whitespace-pre-wrap">• 15 tiêu chí</p>
    </div>
  );
}
...
function Container101() {
  return (
    <div className="h-[54px] relative shrink-0 w-[313.469px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Heading1 />
        <Paragraph17 />
      </div>
...
function Container102() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[54px] items-center left-[20px] top-[20px] w-[860px]" data-name="Container">
      <Icon68 />
      <Container101 />
    </div>
  );
...
function Button62() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[852px] rounded-[4px] size-[32px] top-[16px]" data-name="Button">
      <Icon69 />
    </div>
  );
}
...
function Container103() {
  return (
    <div className="absolute border-[#d0d5dd] border-[0px_0px_1px] border-solid h-[95px] left-0 top-0 w-[900px]" data-name="Container">
      <Container102 />
      <Button62 />
    </div>
  );
...
function FormCriteriaModal() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.5)] h-[855px] left-[317px] top-[175px] w-[900px]" data-name="FormCriteriaModal">
      <Container19 />
      <Container22 />
      <Container98 />
      <Container100 />
