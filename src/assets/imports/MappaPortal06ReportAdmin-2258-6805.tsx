import svgPaths from "./svg-6x0jdc18k3";
...
function FormCriteriaModal() {
  return <div className="absolute bg-[rgba(0,0,0,0.4)] h-[935px] left-0 top-[135px] w-[1534px]" data-name="FormCriteriaModal" />;
}
...
function Icon49() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p3713e00} id="Vector" stroke="var(--stroke-0, #005CB6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.pd2076c0} id="Vector_2" stroke="var(--stroke-0, #005CB6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M8.33333 7.5H6.66667" id="Vector_3" stroke="var(--stroke-0, #005CB6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M13.3333 10.8333H6.66667" id="Vector_4" stroke="var(--stroke-0, #005CB6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M13.3333 14.1667H6.66667" id="Vector_5" stroke="var(--stroke-0, #005CB6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Container19() {
  return (
    <div className="bg-[#f2f4f7] relative rounded-[8px] shrink-0 size-[40px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <Icon49 />
      </div>
    </div>
...
function Heading1() {
  return (
    <div className="h-[30px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[30px] left-0 not-italic text-[#101828] text-[20px] top-0 whitespace-pre">Kiểm tra Cơ sở Kinh doanh Hàng giả</p>
    </div>
  );
}
...
function Code() {
  return (
    <div className="bg-[#f2f4f7] h-[22px] relative rounded-[8px] shrink-0 w-[95.203px]" data-name="Code">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">KT_HANG_GIA</p>
      </div>
    </div>
  );
}
...
function Text20() {
  return (
    <div className="h-[21px] relative shrink-0 w-[7.875px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 whitespace-pre">•</p>
      </div>
    </div>
  );
}
...
function Text21() {
  return (
    <div className="h-[21px] relative shrink-0 w-[65.953px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[66px] whitespace-pre-wrap">15 tiêu chí</p>
      </div>
    </div>
  );
}
...
function Container23() {
  return (
    <div className="absolute content-stretch flex h-[105px] items-start justify-between left-0 pb-px pt-[24px] px-[24px] top-0 w-[900px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#d0d5dd] border-[0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <Container22 />
      <Button43 />
    </div>
...
function Paragraph1() {
  return (
    <div className="h-[44.813px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[22.4px] left-0 not-italic text-[#101828] text-[14px] top-0 w-[806px] whitespace-pre-wrap">Biểu mẫu kiểm tra nghiệp vụ cho chuyên đề kiểm tra cơ sở kinh doanh hàng giả, hàng nhái, hàng vi phạm quyền sở hữu trí tuệ</p>
    </div>
  );
}
...
function Container24() {
  return (
    <div className="absolute bg-[#f2f4f7] content-stretch flex flex-col h-[76.813px] items-start left-[24px] pb-0 pl-[24px] pr-[20px] pt-[16px] rounded-[8px] top-[105px] w-[852px]" data-name="Container">
...
function Icon51() {
  return (
    <div className="absolute left-[16px] size-[16px] top-[12.5px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
...
function Button44() {
  return (
    <div className="absolute bg-white border border-[#d0d5dd] border-solid h-[43px] left-0 rounded-[8px] top-0 w-[152.875px]" data-name="Button">
      <Icon51 />
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[21px] left-[86px] not-italic text-[#101828] text-[14px] text-center top-[10px] translate-x-[-50%] whitespace-pre">Mở rộng tất cả</p>
    </div>
  );
}
...
function Button45() {
  return (
    <div className="absolute bg-white border border-[#d0d5dd] border-solid h-[43px] left-[160.88px] rounded-[8px] top-0 w-[152.25px]" data-name="Button">
      <Icon52 />
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[21px] left-[86.5px] not-italic text-[#101828] text-[14px] text-center top-[10px] translate-x-[-50%] whitespace-pre">Thu gọn tất cả</p>
    </div>
  );
}
...
function Button46() {
  return (
    <div className="absolute bg-white border border-[#d0d5dd] border-solid h-[43px] left-[321.13px] rounded-[8px] top-0 w-[126.453px]" data-name="Button">
      <Icon53 />
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[21px] left-[73.5px] not-italic text-[#101828] text-[14px] text-center top-[10px] translate-x-[-50%] whitespace-pre">Xuất Excel</p>
    </div>
  );
}
...
function Container25() {
  return (
    <div className="absolute h-[43px] left-[428.42px] top-0 w-[447.578px]" data-name="Container">
      <Button44 />
      <Button45 />
      <Button46 />
    </div>
...
function TextInput2() {
  return (
    <div className="absolute bg-[#f9fafb] h-[43px] left-0 rounded-[8px] top-0 w-[392.422px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip pl-[42px] pr-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(16,24,40,0.5)] whitespace-pre">Tìm kiếm tiêu chí...</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container26() {
  return (
    <div className="absolute h-[43px] left-[24px] top-0 w-[392.422px]" data-name="Container">
      <TextInput2 />
      <Icon54 />
    </div>
  );
...
function Container27() {
  return (
    <div className="absolute h-[59px] left-0 top-[205.81px] w-[900px]" data-name="Container">
      <Container25 />
      <Container26 />
    </div>
  );
...
function Container28() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
...
function Heading2() {
  return (
    <div className="h-[24px] relative shrink-0 w-[207.453px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Code1() {
  return (
    <div className="bg-[#f2f4f7] h-[22px] relative rounded-[8px] shrink-0 w-[66.406px]" data-name="Code">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_01</p>
      </div>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[614px] whitespace-pre-wrap">Xác nhận cán bộ đã đến đúng địa chỉ cơ sở cần kiểm tra theo kế hoạch. Đối chiếu với GPS và thông tin hồ sơ.</p>
    </div>
  );
}
...
function Icon55() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d="M5 7.5L10 12.5L15 7.5" id="Vector" stroke="var(--stroke-0, #667085)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Container31() {
  return (
    <div className="h-[72px] relative shrink-0 w-[118.391px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text22 />
        <Icon55 />
      </div>
...
function Container33() {
  return (
    <div className="bg-white h-[27.172px] relative rounded-[8px] shrink-0 w-[852px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip p-px relative rounded-[inherit] size-full">
        <Container32 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[8px]" />
...
function Heading3() {
  return (
    <div className="h-[24px] relative shrink-0 w-[194.5px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Code2() {
  return (
    <div className="bg-[#f2f4f7] h-[22px] relative rounded-[8px] shrink-0 w-[66.406px]" data-name="Code">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_02</p>
      </div>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[632px] whitespace-pre-wrap">Chụp ảnh biển hiệu, bảng tên của cơ sở kinh doanh từ ít nhất 2 góc độ khác nhau. Đảm bảo ảnh rõ nét, đầy đủ ánh sáng.</p>
    </div>
  );
}
...
function Heading4() {
  return (
    <div className="h-[24px] relative shrink-0 w-[201.781px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Code3() {
  return (
    <div className="bg-[#f2f4f7] h-[22px] relative rounded-[8px] shrink-0 w-[66.406px]" data-name="Code">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_03</p>
      </div>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[609px] whitespace-pre-wrap">Chụp ảnh tổng quan bên ngoài và bên trong cơ sở, bao gồm mặt tiền, khu vực bày bán hàng hóa, kho chứa (nếu có).</p>
    </div>
  );
}
...
function Heading5() {
  return (
    <div className="h-[24px] relative shrink-0 w-[256.453px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Code4() {
  return (
    <div className="bg-[#f2f4f7] h-[22px] relative rounded-[8px] shrink-0 w-[66.406px]" data-name="Code">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_04</p>
      </div>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[611px] whitespace-pre-wrap">Xác nhận đã gặp chủ cơ sở hoặc người được ủy quyền đại diện hợp pháp. Ghi nhận thông tin liên hệ.</p>
    </div>
  );
}
...
function Heading6() {
  return (
    <div className="h-[24px] relative shrink-0 w-[186.469px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Code5() {
  return (
    <div className="bg-[#f2f4f7] h-[22px] relative rounded-[8px] shrink-0 w-[66.406px]" data-name="Code">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_05</p>
      </div>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[600px] whitespace-pre-wrap">Nhập họ tên, số CMND/CCCD, số điện thoại của người đại diện cơ sở. Chụp ảnh giấy tờ tùy thân.</p>
    </div>
  );
}
...
function Heading7() {
  return (
    <div className="h-[24px] relative shrink-0 w-[236.203px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Code6() {
  return (
    <div className="bg-[#f2f4f7] h-[22px] relative rounded-[8px] shrink-0 w-[66.406px]" data-name="Code">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_06</p>
      </div>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[628px] whitespace-pre-wrap">Kiểm tra Giấy chứng nhận đăng ký kinh doanh hoặc Giấy phép kinh doanh có điều kiện (nếu áp dụng). Chụp ảnh giấy phép.</p>
    </div>
  );
}
...
function Heading8() {
  return (
    <div className="h-[24px] relative shrink-0 w-[259.484px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Code7() {
  return (
    <div className="bg-[#f2f4f7] h-[22px] relative rounded-[8px] shrink-0 w-[66.406px]" data-name="Code">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_07</p>
      </div>
    </div>
  );
}
...
function Container67() {
  return (
    <div className="h-[51px] relative shrink-0 w-[120.469px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text28 />
        <Icon61 />
      </div>
...
function Container69() {
  return (
    <div className="bg-white h-[22.078px] relative rounded-[8px] shrink-0 w-[852px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip p-px relative rounded-[inherit] size-full">
        <Container68 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[8px]" />
...
function Heading9() {
  return (
    <div className="h-[24px] relative shrink-0 w-[246.781px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Code8() {
  return (
    <div className="bg-[#f2f4f7] h-[22px] relative rounded-[8px] shrink-0 w-[66.406px]" data-name="Code">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_08</p>
      </div>
    </div>
  );
}
...
function Paragraph9() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[592px] whitespace-pre-wrap">Liệt kê các nhóm hàng hóa chính mà cơ sở đang kinh doanh (ví dụ: quần áo, giày dép, mỹ phẩm, điện tử...).</p>
    </div>
  );
}
...
function Heading10() {
  return (
    <div className="h-[24px] relative shrink-0 w-[213.797px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Code9() {
  return (
    <div className="bg-[#f2f4f7] h-[22px] relative rounded-[8px] shrink-0 w-[66.406px]" data-name="Code">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_09</p>
      </div>
    </div>
  );
}
...
function Heading11() {
  return (
    <div className="h-[24px] relative shrink-0 w-[215.75px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Code10() {
  return (
    <div className="bg-[#f2f4f7] h-[22px] relative rounded-[8px] shrink-0 w-[66.406px]" data-name="Code">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_10</p>
      </div>
    </div>
  );
}
...
function Paragraph11() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[624px] whitespace-pre-wrap">Nếu phát hiện hàng nghi ngờ, chụp ảnh chi tiết sản phẩm, tem nhãn, logo, bao bì. Chụp cả góc độ tổng thể và cận cảnh.</p>
    </div>
  );
}
...
function Container85() {
  return (
    <div className="h-[72px] relative shrink-0 w-[120.469px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text31 />
        <Icon64 />
      </div>
...
function Heading12() {
  return (
    <div className="h-[24px] relative shrink-0 w-[213.844px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Code11() {
  return (
    <div className="bg-[#f2f4f7] h-[22px] relative rounded-[8px] shrink-0 w-[66.406px]" data-name="Code">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_11</p>
      </div>
    </div>
  );
}
...
function Paragraph12() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[624px] whitespace-pre-wrap">Mô tả chi tiết về hàng hóa nghi ngờ: tên sản phẩm, nhãn hiệu, xuất xứ ghi trên bao bì, số lượng ước tính, giá bán.</p>
    </div>
  );
}
...
function Heading13() {
  return (
    <div className="h-[24px] relative shrink-0 w-[160.5px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Code12() {
  return (
    <div className="bg-[#f2f4f7] h-[22px] relative rounded-[8px] shrink-0 w-[66.406px]" data-name="Code">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_12</p>
      </div>
    </div>
  );
}
...
function Container97() {
  return (
    <div className="h-[51px] relative shrink-0 w-[118.391px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text33 />
        <Icon66 />
      </div>
...
function Heading14() {
  return (
    <div className="h-[24px] relative shrink-0 w-[187.297px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Code13() {
  return (
    <div className="bg-[#f2f4f7] h-[22px] relative rounded-[8px] shrink-0 w-[66.406px]" data-name="Code">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_13</p>
      </div>
    </div>
  );
}
...
function Heading15() {
  return (
    <div className="h-[24px] relative shrink-0 w-[129.625px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Code14() {
  return (
    <div className="bg-[#f2f4f7] h-[22px] relative rounded-[8px] shrink-0 w-[66.406px]" data-name="Code">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_14</p>
      </div>
    </div>
  );
}
...
function Paragraph15() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[634px] whitespace-pre-wrap">Nhận xét tổng quan về tình trạng cơ sở, mức độ tuân thủ pháp luật, đề xuất biện pháp xử lý (nếu có).</p>
    </div>
  );
}
...
function Heading16() {
  return (
    <div className="h-[24px] relative shrink-0 w-[128.781px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Code15() {
  return (
    <div className="bg-[#f2f4f7] h-[22px] relative rounded-[8px] shrink-0 w-[66.406px]" data-name="Code">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_15</p>
      </div>
    </div>
  );
}
...
function Container118() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] h-[579.188px] items-start left-0 overflow-clip pl-[24px] pr-0 py-0 top-[264.81px] w-[900px]" data-name="Container">
      <Container33 />
      <Container39 />
      <Container45 />
      <Container51 />
...
function Paragraph17() {
  return (
    <div className="h-[21px] relative shrink-0 w-[147.234px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Button47() {
  return (
    <div className="bg-[#005cb6] h-[41px] relative rounded-[8px] shrink-0 w-[71.969px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[21px] left-[36px] not-italic text-[14px] text-center text-white top-[10px] translate-x-[-50%] whitespace-pre">Đóng</p>
      </div>
    </div>
  );
}
...
function Container119() {
  return (
    <div className="absolute content-stretch flex h-[74px] items-center justify-between left-0 pb-0 pt-px px-[24px] top-[844px] w-[900px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#d0d5dd] border-[1px_0px_0px] border-solid inset-0 pointer-events-none" />
      <Paragraph17 />
      <Button47 />
    </div>
...
function FormCriteriaModal1() {
  return (
    <div className="absolute bg-white h-[918px] left-[317px] overflow-clip rounded-[8px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_10px_10px_-5px_rgba(0,0,0,0.04)] top-[143.5px] w-[900px]" data-name="FormCriteriaModal">
      <Container23 />
      <Container24 />
      <Container27 />
      <Container118 />
