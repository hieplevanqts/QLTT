import svgPaths from "./svg-dxz7uhbilz";
...
function UserModal() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[12px] h-[81px] items-center left-[394px] pb-px pt-0 px-[24px] rounded-tl-[8px] rounded-tr-[8px] top-[71px] w-[600px]" data-name="UserModal">
...
function Button113() {
  return (
    <div className="bg-[#f2f4f7] h-[47px] relative rounded-[6px] shrink-0 w-[68.906px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[21px] py-[13px] relative size-full">
...
function Icon170() {
  return (
    <div className="absolute left-[20px] size-[16px] top-[15.5px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
...
function Button114() {
  return (
    <div className="bg-[#005cb6] h-[47px] relative rounded-[6px] shrink-0 w-[89.203px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon170 />
        <p className="absolute css-ew64yg font-['Inter:Medium',sans-serif] font-medium leading-[21px] left-[57px] not-italic text-[14px] text-center text-white top-[13px] translate-x-[-50%]">Lưu</p>
      </div>
    </div>
  );
}
...
function UserModal1() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[12px] h-[96px] items-start justify-end left-[394px] pb-0 pl-0 pr-[24px] pt-[25px] rounded-bl-[8px] rounded-br-[8px] top-[794px] w-[600px]" data-name="UserModal">
      <div aria-hidden="true" className="absolute border-[#d0d5dd] border-solid border-t inset-0 pointer-events-none rounded-bl-[8px] rounded-br-[8px]" />
      <Button113 />
      <Button114 />
    </div>
  );
...
function Label() {
  return (
    <div className="absolute h-[21px] left-0 top-0 w-[552px]" data-name="Label">
...
function Small() {
  return (
    <div className="absolute h-[18px] left-0 top-[84px] w-[552px]" data-name="Small">
...
function EmailInput() {
  return (
    <div className="absolute bg-[#f2f4f7] h-[47px] left-0 opacity-60 rounded-[6px] top-0 w-[552px]" data-name="Email Input">
...
function Container152() {
  return (
    <div className="absolute h-[47px] left-0 top-[29px] w-[552px]" data-name="Container">
      <EmailInput />
      <Icon171 />
    </div>
  );
...
function Container153() {
  return (
    <div className="h-[102px] relative shrink-0 w-[552px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Label />
        <Small />
        <Container152 />
...
function Text85() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[51.63px] top-[2px] w-[7.297px]" data-name="Text">
      <p className="css-ew64yg font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#d92d20] text-[14px]">*</p>
    </div>
  );
}
...
function Label1() {
  return (
    <div className="h-[21px] relative shrink-0 w-[552px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-ew64yg font-['Inter:Medium',sans-serif] font-medium leading-[21px] left-0 not-italic text-[#101828] text-[14px] top-0">Họ tên</p>
        <Text85 />
      </div>
    </div>
  );
...
function TextInput2() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[6px] w-[552px]" data-name="Text Input">
...
function Container154() {
  return (
    <div className="h-[76px] relative shrink-0 w-[552px]" data-name="Container">
...
function PhoneInput() {
  return (
    <div className="absolute bg-white h-[47px] left-0 rounded-[6px] top-0 w-[552px]" data-name="Phone Input">
      <div className="content-stretch flex items-center overflow-clip pl-[40px] pr-[12px] py-[12px] relative rounded-[inherit] size-full">
...
function Dropdown() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[6px] w-[552px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-px pl-[-442px] pr-[994px] pt-[-484px] relative size-full">
        <Option />
        <Option1 />
      </div>
    </div>
...
function Container157() {
  return (
    <div className="h-[74px] relative shrink-0 w-[552px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] items-start relative size-full">
        <Label3 />
        <Dropdown />
      </div>
...
function Checkbox() {
  return <div className="absolute left-[8px] size-[18px] top-[12px]" data-name="Checkbox" />;
}

function Icon173() {
  return (
    <div className="absolute left-0 size-[14px] top-[5.17px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="Icon">
...
function Container160() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[2px] h-[39.797px] items-start left-[38px] top-[10px] w-[465px]" data-name="Container">
      <Container158 />
      <Container159 />
    </div>
  );
...
function Label5() {
  return (
    <div className="h-[59.797px] relative rounded-[4px] shrink-0 w-full" data-name="Label">
      <Checkbox />
      <Container160 />
    </div>
  );
...
function Container179() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[6px] w-[552px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip pb-px pl-[13px] pr-[28px] pt-[13px] relative rounded-[inherit] size-full">
        <Label5 />
        <Label6 />
        <Label7 />
        <Label8 />
...
function Small1() {
  return (
    <div className="h-[18px] relative shrink-0 w-[552px]" data-name="Small">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Container180() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[552px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] items-start relative size-full">
        <Label4 />
        <Container179 />
        <Small1 />
...
function Dropdown1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[6px] w-[552px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-px pl-[-442px] pr-[994px] pt-[-853px] relative size-full">
        <Option2 />
        <Option3 />
        <Option4 />
        <Option5 />
...
function Container181() {
  return (
    <div className="h-[100px] relative shrink-0 w-[552px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] items-start relative size-full">
        <Label12 />
        <Dropdown1 />
        <Small2 />
...
function Small3() {
  return (
    <div className="absolute h-[18px] left-0 top-[84px] w-[552px]" data-name="Small">
      <p className="absolute css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#005cb6] text-[12px] top-0">✅ Tên đăng nhập được tạo tự động từ Phòng ban + Họ tên</p>
    </div>
  );
}
...
function TextInput3() {
  return (
    <div className="absolute bg-white h-[47px] left-0 opacity-60 rounded-[6px] top-0 w-[552px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip pl-[40px] pr-[12px] py-[12px] relative rounded-[inherit] size-full">
...
function Form() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[600px]" data-name="Form">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[20px] items-start overflow-clip pl-[24px] pr-0 py-[24px] relative rounded-[inherit] size-full">
        <Container153 />
        <Container154 />
        <Container156 />
        <Container157 />
...
function Container184() {
  return (
    <div className="bg-white h-[783px] relative rounded-[8px] shadow-[0px_10px_40px_0px_rgba(0,0,0,0.2)] shrink-0 w-[600px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[-251px] pt-[81px] px-0 relative size-full">
        <Form />
      </div>
    </div>
  );
