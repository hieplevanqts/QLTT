import svgPaths from "./svg-11tdwd804t";
...
function Icon2() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_2341_617)" id="Icon">
...
function Container17() {
  return (
    <div className="h-[56px] relative rounded-[6px] shrink-0 w-full" data-name="Container">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pl-[74px] pr-[140px] py-0 relative size-full">
          <Container16 />
        </div>
      </div>
    </div>
...
function Container21() {
  return (
    <div className="absolute content-stretch flex flex-col h-[112px] items-start left-[16px] pl-[12px] pr-0 py-0 top-[56px] w-[1288px]" data-name="Container">
      <Container17 />
      <Container20 />
    </div>
  );
...
function Icon36() {
  return (
    <div className="absolute left-0 size-[16px] top-0" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_2341_2997)" id="Icon">
          <path d={svgPaths.pda21400} id="Vector" stroke="var(--stroke-0, #101828)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p1be36900} id="Vector_2" stroke="var(--stroke-0, #101828)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.pa8d100} id="Vector_3" stroke="var(--stroke-0, #101828)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M6.66667 4H9.33333" id="Vector_4" stroke="var(--stroke-0, #101828)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
...
function BoldText() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[70.84px] top-0 w-[10.328px]" data-name="Bold Text">
      <p className="css-ew64yg font-['Inter:Bold',sans-serif] font-bold leading-[24px] not-italic relative shrink-0 text-[#101828] text-[16px]">3</p>
    </div>
  );
}
...
function Text14() {
  return (
    <div className="absolute h-[20px] left-0 top-[18px] w-[131.844px]" data-name="Text">
      <p className="absolute css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-3px]">Tổng số:</p>
      <BoldText />
      <p className="absolute css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[81.17px] not-italic text-[#101828] text-[16px] top-[-3px]">đơn vị</p>
    </div>
  );
}
...
function AdminPage() {
  return (
    <div className="bg-[#f9fafb] h-[897.5px] relative shrink-0 w-full" data-name="AdminPage">
...
function MainLayout() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex flex-col h-[1017.5px] items-start left-0 top-0 w-[1404px]" data-name="MainLayout">
      <TopUtilityBar3 />
      <HorizontalNavBar />
      <AdminPage />
    </div>
...
function Option2() {
  return (
    <div className="h-0 relative shrink-0 w-full" data-name="Option">
      <p className="absolute css-4hzbpn font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#101828] text-[14px] top-[-2px] w-0">đôi qltt 1 (QLTT1) - Cấp 2</p>
    </div>
  );
}
...
function Option3() {
  return (
    <div className="h-0 relative shrink-0 w-full" data-name="Option">
      <p className="absolute css-4hzbpn font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#101828] text-[14px] top-[-2px] w-0">QLTT2 (QLTT2) - Cấp 2</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[6px] w-[560px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[14px] py-[9px] relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(16,24,40,0.5)]">đôi qltt 1</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
...
function TextInput3() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[6px] w-[560px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[14px] py-[9px] relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(16,24,40,0.5)]">QLTT1</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
  ...
  return (
    <div className="h-[21px] relative shrink-0 w-[560px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <p className="css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#101828] text-[14px]">Cấp</p>
      </div>
    </div>
  );
}
...
function NumberInput() {
  return (
    <div className="bg-[#f2f4f7] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px] w-[560px]" data-name="Number Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[14px] py-[9px] relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#101828] text-[14px]">2</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
...
function Small1() {
  return (
    <div className="h-[18px] relative shrink-0 w-[560px]" data-name="Small">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#667085] text-[12px] top-0">Cấp được tự động tính dựa trên đơn vị cha</p>
      </div>
    </div>
  );
}
...
function TextInput4() {
  return (
    <div className="bg-[#f2f4f7] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px] w-[560px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[14px] py-[9px] relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Cousine:Regular',sans-serif] leading-[19.5px] not-italic relative shrink-0 text-[#101828] text-[13px]">/cuc_cong_nghe_thong_tin.QLTT1</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
...
function DepartmentModal() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.5)] content-stretch flex h-[855px] items-center justify-center left-0 top-0 w-[1404px]" data-name="DepartmentModal">
      <Form />
    </div>
  );
}
