import svgPaths from "./svg-vhpg868lne";
...
function Text4() {
  return (
    <div className="h-[20px] relative shrink-0 w-[148.109px]" data-name="Text">
...
function Text6() {
  return (
    <div className="bg-[#005cb6] h-[20px] relative rounded-[9999px] shrink-0 w-[37.047px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[8px] py-[2px] relative size-full">
        <p className="css-ew64yg font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[11px] text-white">Cục</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-[#f2f4f7] flex-[1_0_0] h-[22px] min-h-px min-w-px relative rounded-[9999px]" data-name="Text">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[9px] py-[3px] relative size-full">
          <p className="css-ew64yg font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#667085] text-[11px]">1 đơn vị con</p>
        </div>
      </div>
    </div>
  );
...
function Container12() {
  return (
    <div className="h-[22px] relative shrink-0 w-[125.172px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text6 />
        <Text7 />
      </div>
...
function Container14() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[56px] items-center left-0 pl-[12px] pr-[140px] py-0 rounded-[6px] top-0 w-[1304px]" data-name="Container">
      <Button29 />
      <Container13 />
    </div>
  );
...
function Text8() {
  return (
    <div className="h-[20px] relative shrink-0 w-[220.281px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
...
function Text9() {
  return (
    <div className="h-[16px] relative shrink-0 w-[39.609px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-4hzbpn font-['Cousine:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#667085] text-[12px] top-0 w-[40px]">(QT01)</p>
      </div>
    </div>
  );
}
...
function Text10() {
  return (
    <div className="bg-[#005cb6] h-[20px] relative rounded-[9999px] shrink-0 w-[55.703px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[8px] py-[2px] relative size-full">
        <p className="css-ew64yg font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[11px] text-white">Chi cục</p>
      </div>
    </div>
  );
}
...
function Container16() {
  return (
    <div className="h-[22px] relative shrink-0 w-[143.828px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text10 />
        <Text11 />
      </div>
...
function Container18() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[56px] items-center left-[12px] pl-[38px] pr-[140px] py-0 rounded-[6px] top-0 w-[1276px]" data-name="Container">
...
function Text12() {
  return (
    <div className="h-[20px] relative shrink-0 w-[129.25px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute css-ew64yg font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#101828] text-[14px] top-0">Quản lý thị trường 1</p>
      </div>
    </div>
  );
}
...
function Text13() {
  return (
    <div className="h-[16px] relative shrink-0 w-[59.406px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-4hzbpn font-['Cousine:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#667085] text-[12px] top-0 w-[60px]">(QT01001)</p>
      </div>
    </div>
  );
}
...
function Text14() {
  return (
    <div className="bg-[#005cb6] h-[20px] relative rounded-[9999px] shrink-0 w-[33.594px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[8px] py-[2px] relative size-full">
        <p className="css-ew64yg font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[11px] text-white">Đội</p>
      </div>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="absolute content-stretch flex h-[56px] items-center left-[28px] pl-[98px] pr-[140px] py-0 rounded-[6px] top-[56px] w-[1260px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#d0d5dd] border-l-2 border-solid inset-0 pointer-events-none rounded-[6px]" />
      <Container20 />
    </div>
  );
...
function Container22() {
  return (
    <div className="absolute h-[112px] left-[16px] top-[56px] w-[1288px]" data-name="Container">
      <Container18 />
      <Container21 />
    </div>
  );
...
function BoldText() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[61.98px] top-[2px] w-[8.922px]" data-name="Bold Text">
      <p className="css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#101828] text-[14px]">3</p>
    </div>
  );
}
  ...
  return (
    <div className="flex-[1_0_0] h-[21px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        ...
        <BoldText />
        <p className="absolute css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-[70.91px] not-italic text-[#667085] text-[14px] top-0">đơn vị</p>
      </div>
    </div>
  );
}
...
function Container26() {
  return (
    <div className="h-[21px] relative shrink-0 w-[139.25px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Icon37 />
        <Text15 />
      </div>
...
function Container27() {
  return (
    <div className="bg-white h-[55px] relative rounded-[8px] shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_1px_3px_0px_rgba(16,24,40,0.1),0px_1px_2px_0px_rgba(16,24,40,0.06)]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pl-[21px] pr-[1193.75px] py-px relative size-full">
          <Container26 />
        </div>
      </div>
    </div>
...
function Option1() {
  return (
    <div className="h-0 relative shrink-0 w-full" data-name="Option">
      <p className="absolute css-4hzbpn font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#101828] text-[14px] top-[-2px] w-0">Chi cục quản lý thị trường Hà Nội (QT01) - Cấp 2</p>
    </div>
  );
}
...
function Option2() {
  return (
    <div className="h-0 relative shrink-0 w-full" data-name="Option">
      <p className="absolute css-4hzbpn font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#101828] text-[14px] top-[-2px] w-0">Cục quản lý thị trường (CCTT) - Cấp 1</p>
    </div>
  );
}
...
function Option3() {
  return (
    <div className="h-0 relative shrink-0 w-full" data-name="Option">
      <p className="absolute css-4hzbpn font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#101828] text-[14px] top-[-2px] w-0">Quản lý thị trường 1 (QT01001) - Cấp 3</p>
    </div>
  );
}
...
function Dropdown() {
  return (
    <div className="absolute content-stretch flex flex-col h-[43px] items-start left-0 pb-px pl-[-422px] pr-[982px] pt-[-203.25px] rounded-[6px] top-[37px] w-[560px]" data-name="Dropdown" style={{ backgroundImage: "linear-gradient(4.39088deg, rgba(0, 0, 0, 0) 50%, rgb(16, 24, 40) 50%), linear-gradient(175.609deg, rgb(16, 24, 40) 50%, rgba(0, 0, 0, 0) 50%), linear-gradient(90deg, rgb(249, 250, 251) 0%, rgb(249, 250, 251) 100%)" }}>
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <Option />
      <Option1 />
      <Option2 />
...
function Container30() {
  return (
    <div className="h-[80px] relative shrink-0 w-[560px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Label />
        <Dropdown />
      </div>
  ...
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[6px] w-[560px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[14px] py-[9px] relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(16,24,40,0.5)]">Chi cục quản lý thị trường Hà Nội</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
...
function Container31() {
  return (
    <div className="h-[78px] relative shrink-0 w-[560px]" data-name="Container">
...
function TextInput3() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[6px] w-[560px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[14px] py-[9px] relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(16,24,40,0.5)]">QT01</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
...
function Small() {
  return (
    <div className="h-[18px] relative shrink-0 w-[560px]" data-name="Small">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#667085] text-[12px] top-0">Không thể thay đổi mã đơn vị sau khi tạo</p>
      </div>
    </div>
  );
}
...
function Container32() {
  return (
    <div className="h-[104px] relative shrink-0 w-[560px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[16px] items-start relative size-full">
        <Label2 />
        <TextInput3 />
        <Small />
...
function TextInput4() {
  return (
    <div className="bg-[#f2f4f7] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px] w-[560px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[14px] py-[9px] relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#101828] text-[14px]">Chi cục</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
...
function Small1() {
  return (
    <div className="h-[18px] relative shrink-0 w-[560px]" data-name="Small">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#667085] text-[12px] top-0">Loại được tự động xác định dựa trên đơn vị cha</p>
      </div>
    </div>
  );
}
...
function Container33() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[560px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[16px] items-start relative size-full">
        <Label3 />
        <TextInput4 />
        <Small1 />
...
function TextInput5() {
  return (
    <div className="bg-[#f2f4f7] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px] w-[560px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[14px] py-[9px] relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Cousine:Regular',sans-serif] leading-[19.5px] not-italic relative shrink-0 text-[#101828] text-[13px]">CCTT.QT01</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
...
function Container34() {
  return (
    <div className="h-[76.5px] relative shrink-0 w-[560px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[16px] items-start relative size-full">
        <Label4 />
        <TextInput5 />
      </div>
...
function Container35() {
  return (
    <div className="h-[546.5px] relative shrink-0 w-full" data-name="Container">
...
function Button32() {
  return (
    <div className="absolute bg-[#005cb6] h-[43px] left-[459.83px] rounded-[6px] top-[21px] w-[120.172px]" data-name="Button">
      <Icon40 />
...
function Button33() {
  return (
    <div className="absolute bg-white content-stretch flex h-[43px] items-center left-[382.92px] px-[19px] py-[11px] rounded-[6px] top-[21px] w-[64.906px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[6px]" />
...
function Form() {
  return (
    <div className="bg-white h-[698.5px] relative rounded-[8px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1)] shrink-0 w-[600px]" data-name="Form">
...
function DepartmentModal() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.5)] content-stretch flex h-[855px] items-center justify-center left-0 top-[173px] w-[1404px]" data-name="DepartmentModal">
      <Form />
    </div>
  );
}
