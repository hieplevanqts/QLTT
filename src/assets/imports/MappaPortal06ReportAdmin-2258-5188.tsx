import svgPaths from "./svg-nc9lxxn6dr";
...
function Icon2() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_2258_5192)" id="Icon">
...
function Dropdown() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[41px] items-start left-[658.48px] pb-px pl-[-704.484px] pr-[884.484px] pt-[-447.5px] rounded-[8px] top-px w-[180px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Option />
      <Option1 />
      <Option2 />
...
function Paragraph1() {
  return (
    <div className="h-[22.391px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[22.4px] left-0 not-italic text-[#101828] text-[14px] top-0 whitespace-pre">Biểu mẫu kiểm tra nghiệp vụ cho chuyên đề kiểm tra cơ sở kinh doanh hàng giả, hàng nhái, hàng vi phạm quyền sở hữu trí tuệ</p>
    </div>
  );
}
...
function Container19() {
  return (
    <div className="absolute bg-[#f2f4f7] content-stretch flex flex-col h-[54.391px] items-start left-0 pb-0 pl-[20px] pr-[16px] pt-[16px] rounded-[8px] top-[94px] w-[900px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#005cb6] border-[0px_0px_0px_4px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Paragraph1 />
    </div>
  );
}
...
function Button44() {
  return (
    <div className="absolute bg-white border border-[#d0d5dd] border-solid h-[43px] left-[166.88px] rounded-[6px] top-0 w-[158.25px]" data-name="Button">
      <Icon50 />
...
function Button45() {
  return (
    <div className="absolute bg-white border border-[#d0d5dd] border-solid h-[43px] left-[333.13px] rounded-[6px] top-0 w-[132.453px]" data-name="Button">
      <Icon51 />
...
function Container20() {
  return (
    <div className="absolute h-[43px] left-[416px] top-0 w-[465.578px]" data-name="Container">
      <Button43 />
      <Button44 />
      <Button45 />
    </div>
...
function Container22() {
  return (
    <div className="absolute h-[43px] left-0 top-[164.39px] w-[900px]" data-name="Container">
      <Container20 />
      <Container21 />
    </div>
  );
...
function Text20() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-pre">1</p>
      </div>
    </div>
  );
}
...
function BoldText3() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[207.453px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Xác nhận địa điểm kiểm tra</p>
    </div>
  );
}
...
function Code() {
  return (
    <div className="absolute bg-[#f2f4f7] h-[22px] left-[215.45px] rounded-[8px] top-px w-[66.406px]" data-name="Code">
      <p className="absolute font-['JetBrains_Mono:Medium',sans-serif] font-medium leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_01</p>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[676px] whitespace-pre-wrap">Xác nhận cán bộ đã đến đúng địa chỉ cơ sở cần kiểm tra theo kế hoạch. Đối chiếu với GPS và thông tin hồ sơ.</p>
    </div>
  );
}
...
function Text21() {
  return (
    <div className="bg-[rgba(217,45,32,0.1)] flex-[1_0_0] h-[26px] min-h-px min-w-px relative rounded-[999px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-[12px] not-italic text-[#d92d20] text-[12px] top-[4px] tracking-[0.5px] uppercase whitespace-pre">BẮT BUỘC</p>
      </div>
    </div>
  );
}
...
function Container26() {
  return (
    <div className="h-[26px] relative shrink-0 w-[118.391px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text21 />
        <Icon53 />
      </div>
...
function Button46() {
  return (
    <div className="h-[104px] relative shrink-0 w-full" data-name="Button">
...
function Container27() {
  return (
    <div className="bg-white h-[27.297px] relative rounded-[8px] shrink-0 w-[892px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip p-px relative rounded-[inherit] size-full">
        <Button46 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[8px]" />
...
function Text22() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-pre">2</p>
      </div>
    </div>
  );
}
...
function BoldText4() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[194.5px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Chụp ảnh biển hiệu cơ sở</p>
    </div>
  );
}
...
function Code1() {
  return (
    <div className="absolute bg-[#f2f4f7] h-[22px] left-[202.5px] rounded-[8px] top-px w-[66.406px]" data-name="Code">
      <p className="absolute font-['JetBrains_Mono:Medium',sans-serif] font-medium leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_02</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[649px] whitespace-pre-wrap">Chụp ảnh biển hiệu, bảng tên của cơ sở kinh doanh từ ít nhất 2 góc độ khác nhau. Đảm bảo ảnh rõ nét, đầy đủ ánh sáng.</p>
    </div>
  );
}
...
function Text24() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-pre">3</p>
      </div>
    </div>
  );
}
...
function BoldText5() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[201.781px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Chụp ảnh tổng quan cơ sở</p>
    </div>
  );
}
...
function Code2() {
  return (
    <div className="absolute bg-[#f2f4f7] h-[22px] left-[209.78px] rounded-[8px] top-px w-[66.406px]" data-name="Code">
      <p className="absolute font-['JetBrains_Mono:Medium',sans-serif] font-medium leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_03</p>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[670px] whitespace-pre-wrap">Chụp ảnh tổng quan bên ngoài và bên trong cơ sở, bao gồm mặt tiền, khu vực bày bán hàng hóa, kho chứa (nếu có).</p>
    </div>
  );
}
...
function Text26() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-pre">4</p>
      </div>
    </div>
  );
}
...
function BoldText6() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[256.453px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Gặp gỡ chủ cơ sở / người đại diện</p>
    </div>
  );
}
...
function Code3() {
  return (
    <div className="absolute bg-[#f2f4f7] h-[22px] left-[264.45px] rounded-[8px] top-px w-[66.406px]" data-name="Code">
      <p className="absolute font-['JetBrains_Mono:Medium',sans-serif] font-medium leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_04</p>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 whitespace-pre">Xác nhận đã gặp chủ cơ sở hoặc người được ủy quyền đại diện hợp pháp. Ghi nhận thông tin liên hệ.</p>
    </div>
  );
}
...
function Container39() {
  return (
    <div className="h-[51px] relative shrink-0 w-[662.375px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[6px] items-start relative size-full">
        <Container38 />
        <Paragraph5 />
      </div>
...
function Button49() {
  return (
    <div className="h-[83px] relative shrink-0 w-full" data-name="Button">
      <div className="content-stretch flex items-start justify-between pb-0 pt-[16px] px-[16px] relative size-full">
        <Container40 />
        <Container41 />
      </div>
...
function Container42() {
  return (
    <div className="bg-white h-[22.188px] relative rounded-[8px] shrink-0 w-[892px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip p-px relative rounded-[inherit] size-full">
        <Button49 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[8px]" />
...
function Text28() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-pre">5</p>
      </div>
    </div>
  );
}
...
function BoldText7() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[186.469px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Thông tin người đại diện</p>
    </div>
  );
}
...
function Code4() {
  return (
    <div className="absolute bg-[#f2f4f7] h-[22px] left-[194.47px] rounded-[8px] top-px w-[66.406px]" data-name="Code">
      <p className="absolute font-['JetBrains_Mono:Medium',sans-serif] font-medium leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_05</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 whitespace-pre">Nhập họ tên, số CMND/CCCD, số điện thoại của người đại diện cơ sở. Chụp ảnh giấy tờ tùy thân.</p>
    </div>
  );
}
...
function Container44() {
  return (
    <div className="h-[51px] relative shrink-0 w-[636.266px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[6px] items-start relative size-full">
        <Container43 />
        <Paragraph6 />
      </div>
...
function Text30() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-pre">6</p>
      </div>
    </div>
  );
}
...
function BoldText8() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[236.203px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Kiểm tra Giấy phép kinh doanh</p>
    </div>
  );
}
...
function Code5() {
  return (
    <div className="absolute bg-[#f2f4f7] h-[22px] left-[244.2px] rounded-[8px] top-px w-[66.406px]" data-name="Code">
      <p className="absolute font-['JetBrains_Mono:Medium',sans-serif] font-medium leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_06</p>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[675px] whitespace-pre-wrap">Kiểm tra Giấy chứng nhận đăng ký kinh doanh hoặc Giấy phép kinh doanh có điều kiện (nếu áp dụng). Chụp ảnh giấy phép.</p>
    </div>
  );
}
...
function Text32() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-pre">7</p>
      </div>
    </div>
  );
}
...
function BoldText9() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[259.484px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Upload ảnh Giấy phép kinh doanh</p>
    </div>
  );
}
...
function Code6() {
  return (
    <div className="absolute bg-[#f2f4f7] h-[22px] left-[267.48px] rounded-[8px] top-px w-[66.406px]" data-name="Code">
      <p className="absolute font-['JetBrains_Mono:Medium',sans-serif] font-medium leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_07</p>
    </div>
  );
}
...
function Paragraph8() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 whitespace-pre">Upload ảnh hoặc file scan Giấy phép kinh doanh (nếu có). File định dạng JPG, PNG hoặc PDF.</p>
    </div>
  );
}
...
function Container54() {
  return (
    <div className="h-[51px] relative shrink-0 w-[620.266px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[6px] items-start relative size-full">
        <Container53 />
        <Paragraph8 />
      </div>
...
function Text33() {
  return (
    <div className="bg-[rgba(0,92,182,0.1)] flex-[1_0_0] h-[26px] min-h-px min-w-px relative rounded-[999px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-[12px] not-italic text-[#005cb6] text-[12px] top-[4px] tracking-[0.5px] uppercase whitespace-pre">TÙY CHỌN</p>
      </div>
    </div>
  );
}
...
function Container56() {
  return (
    <div className="h-[26px] relative shrink-0 w-[120.469px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text33 />
        <Icon59 />
      </div>
...
function Text34() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-pre">8</p>
      </div>
    </div>
  );
}
...
function BoldText10() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[246.781px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Danh sách hàng hóa kinh doanh</p>
    </div>
  );
}
...
function Code7() {
  return (
    <div className="absolute bg-[#f2f4f7] h-[22px] left-[254.78px] rounded-[8px] top-px w-[66.406px]" data-name="Code">
      <p className="absolute font-['JetBrains_Mono:Medium',sans-serif] font-medium leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_08</p>
    </div>
  );
}
...
function Paragraph9() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[669px] whitespace-pre-wrap">Liệt kê các nhóm hàng hóa chính mà cơ sở đang kinh doanh (ví dụ: quần áo, giày dép, mỹ phẩm, điện tử...).</p>
    </div>
  );
}
...
function Text36() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-pre">9</p>
      </div>
    </div>
  );
}
...
function BoldText11() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[213.797px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Phát hiện hàng nghi ngờ giả</p>
    </div>
  );
}
...
function Code8() {
  return (
    <div className="absolute bg-[#f2f4f7] h-[22px] left-[221.8px] rounded-[8px] top-px w-[66.406px]" data-name="Code">
      <p className="absolute font-['JetBrains_Mono:Medium',sans-serif] font-medium leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_09</p>
    </div>
  );
}
...
function Paragraph10() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[635px] whitespace-pre-wrap">Cán bộ có phát hiện hàng hóa nghi ngờ giả, hàng nhái, hàng xâm phạm quyền sở hữu trí tuệ hay không?</p>
    </div>
  );
}
...
function Text38() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-pre">10</p>
      </div>
    </div>
  );
}
...
function BoldText12() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[215.75px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Chụp ảnh hàng nghi ngờ giả</p>
    </div>
  );
}
...
function Code9() {
  return (
    <div className="absolute bg-[#f2f4f7] h-[22px] left-[223.75px] rounded-[8px] top-px w-[66.406px]" data-name="Code">
      <p className="absolute font-['JetBrains_Mono:Medium',sans-serif] font-medium leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_10</p>
    </div>
  );
}
...
function Paragraph11() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[645px] whitespace-pre-wrap">Nếu phát hiện hàng nghi ngờ, chụp ảnh chi tiết sản phẩm, tem nhãn, logo, bao bì. Chụp cả góc độ tổng thể và cận cảnh.</p>
    </div>
  );
}
...
function Text40() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-pre">11</p>
      </div>
    </div>
  );
}
...
function BoldText13() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[213.844px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Mô tả chi tiết hàng nghi ngờ</p>
    </div>
  );
}
...
function Code10() {
  return (
    <div className="absolute bg-[#f2f4f7] h-[22px] left-[221.84px] rounded-[8px] top-px w-[66.406px]" data-name="Code">
      <p className="absolute font-['JetBrains_Mono:Medium',sans-serif] font-medium leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_11</p>
    </div>
  );
}
...
function Paragraph12() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[653px] whitespace-pre-wrap">Mô tả chi tiết về hàng hóa nghi ngờ: tên sản phẩm, nhãn hiệu, xuất xứ ghi trên bao bì, số lượng ước tính, giá bán.</p>
    </div>
  );
}
...
function Text42() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-pre">12</p>
      </div>
    </div>
  );
}
...
function BoldText14() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[160.5px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Lập biên bản tạm giữ</p>
    </div>
  );
}
...
function Code11() {
  return (
    <div className="absolute bg-[#f2f4f7] h-[22px] left-[168.5px] rounded-[8px] top-px w-[66.406px]" data-name="Code">
      <p className="absolute font-['JetBrains_Mono:Medium',sans-serif] font-medium leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_12</p>
    </div>
  );
}
...
function Paragraph13() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 whitespace-pre">Cán bộ có lập biên bản tạm giữ hàng hóa vi phạm hay không?</p>
    </div>
  );
}
...
function Container79() {
  return (
    <div className="h-[51px] relative shrink-0 w-[407.266px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[6px] items-start relative size-full">
        <Container78 />
        <Paragraph13 />
      </div>
...
function Text44() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-pre">13</p>
      </div>
    </div>
  );
}
...
function BoldText15() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[187.297px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Upload biên bản tạm giữ</p>
    </div>
  );
}
...
function Code12() {
  return (
    <div className="absolute bg-[#f2f4f7] h-[22px] left-[195.3px] rounded-[8px] top-px w-[66.406px]" data-name="Code">
      <p className="absolute font-['JetBrains_Mono:Medium',sans-serif] font-medium leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_13</p>
    </div>
  );
}
...
function Paragraph14() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 whitespace-pre">Upload file scan hoặc ảnh biên bản tạm giữ (nếu có). Đảm bảo chữ ký và đóng dấu rõ ràng.</p>
    </div>
  );
}
...
function Container84() {
  return (
    <div className="h-[51px] relative shrink-0 w-[601.938px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[6px] items-start relative size-full">
        <Container83 />
        <Paragraph14 />
      </div>
...
function Text46() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-pre">14</p>
      </div>
    </div>
  );
}
...
function BoldText16() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[129.625px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Kết luận kiểm tra</p>
    </div>
  );
}
...
function Code13() {
  return (
    <div className="absolute bg-[#f2f4f7] h-[22px] left-[137.63px] rounded-[8px] top-px w-[66.406px]" data-name="Code">
      <p className="absolute font-['JetBrains_Mono:Medium',sans-serif] font-medium leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_14</p>
    </div>
  );
}
...
function Paragraph15() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 whitespace-pre">Nhận xét tổng quan về tình trạng cơ sở, mức độ tuân thủ pháp luật, đề xuất biện pháp xử lý (nếu có).</p>
    </div>
  );
}
...
function Container89() {
  return (
    <div className="h-[51px] relative shrink-0 w-[662.797px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[6px] items-start relative size-full">
        <Container88 />
        <Paragraph15 />
      </div>
...
function Text48() {
  return (
    <div className="bg-[#005cb6] relative rounded-[16px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-pre">15</p>
      </div>
    </div>
  );
}
...
function BoldText17() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[128.781px]" data-name="Bold Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] whitespace-pre">Chữ ký xác nhận</p>
    </div>
  );
}
...
function Code14() {
  return (
    <div className="absolute bg-[#f2f4f7] h-[22px] left-[136.78px] rounded-[8px] top-px w-[66.406px]" data-name="Code">
      <p className="absolute font-['JetBrains_Mono:Medium',sans-serif] font-medium leading-[18px] left-[8px] text-[#667085] text-[12px] top-[2px] whitespace-pre">STEP_15</p>
    </div>
  );
}
...
function Paragraph16() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 whitespace-pre">Chữ ký điện tử của cán bộ thực hiện kiểm tra để xác nhận tính xác thực của thông tin đã nhập.</p>
    </div>
  );
}
...
function Container94() {
  return (
    <div className="h-[51px] relative shrink-0 w-[621.703px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[6px] items-start relative size-full">
        <Container93 />
        <Paragraph16 />
      </div>
...
function Container98() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] h-[549.609px] items-start left-0 overflow-clip pb-0 pl-[4px] pr-0 pt-[4px] top-[223.39px] w-[900px]" data-name="Container">
      <Container27 />
      <Container32 />
      <Container37 />
      <Container42 />
...
function Container99() {
  return (
    <div className="h-[41px] relative shrink-0 w-[147.234px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#667085] text-[14px] top-0 w-[148px] whitespace-pre-wrap">Hiển thị 15 / 15 tiêu chí</p>
      </div>
    </div>
  );
}
...
function Code15() {
  return (
    <div className="absolute bg-[#f2f4f7] h-[22px] left-0 rounded-[8px] top-0 w-[95.203px]" data-name="Code">
      <p className="absolute font-['JetBrains_Mono:Medium',sans-serif] font-medium leading-[18px] left-[8px] text-[#005cb6] text-[12px] top-[2px] whitespace-pre">KT_HANG_GIA</p>
    </div>
  );
}
...
function Paragraph17() {
  return (
    <div className="h-[22px] relative shrink-0 w-full" data-name="Paragraph">
      <Code15 />
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[21px] left-[103.2px] not-italic text-[#667085] text-[14px] top-[0.5px] w-[79px] whitespace-pre-wrap">• 15 tiêu chí</p>
    </div>
  );
}
...
function Container101() {
  return (
    <div className="h-[53px] relative shrink-0 w-[313.469px]" data-name="Container">
...
function Container102() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[53px] items-center left-[20px] top-[20px] w-[860px]" data-name="Container">
      <Icon68 />
      <Container101 />
    </div>
  );
...
function Container103() {
  return (
    <div className="absolute border-[#d0d5dd] border-[0px_0px_1px] border-solid h-[94px] left-0 top-0 w-[900px]" data-name="Container">
      <Container102 />
      <Button62 />
    </div>
  );
...
function FormCriteriaModal() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.5)] h-[855px] left-[317px] top-[40px] w-[900px]" data-name="FormCriteriaModal">
      <Container19 />
      <Container22 />
      <Container98 />
      <Container100 />
