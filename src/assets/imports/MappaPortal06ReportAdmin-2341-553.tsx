import svgPaths from "./svg-29n71hlxx4";
...
function Button24() {
  return (
    <div className="absolute bg-[#005cb6] h-[41px] left-0 rounded-[6px] top-[172px] w-[171.703px]" data-name="Button">
      <Icon26 />
      <p className="absolute css-ew64yg font-['Inter:Medium',sans-serif] font-medium leading-[21px] left-[98px] not-italic text-[14px] text-center text-white top-[10px] translate-x-[-50%]">Thêm đơn vị gốc</p>
    </div>
  );
}
...
function Icon31() {
  return (
    <div className="absolute left-[24px] size-[48px] top-[72px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
        <g id="Icon" opacity="0.5">
          <path d={svgPaths.p1f337080} id="Vector" stroke="var(--stroke-0, #667085)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
          <path d="M24 16V24" id="Vector_2" stroke="var(--stroke-0, #667085)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
          <path d="M24 32H24.02" id="Vector_3" stroke="var(--stroke-0, #667085)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
        </g>
      </svg>
    </div>
  );
...
function Heading1() {
  return (
    <div className="absolute h-[24px] left-[24px] top-[136px] w-[1306px]" data-name="Heading 3">
      <p className="absolute css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[653.25px] not-italic text-[#101828] text-[16px] text-center top-[-1px] translate-x-[-50%]">Chưa có đơn vị nào</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="absolute h-[24px] left-[24px] top-[160px] w-[1306px]" data-name="Paragraph">
      <p className="absolute css-ew64yg font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-[653.38px] not-italic text-[#667085] text-[16px] text-center top-[-1px] translate-x-[-50%]">Bắt đầu bằng cách thêm đơn vị gốc</p>
    </div>
  );
}
...
function Container9() {
  return (
    <div className="bg-white h-[276px] relative shrink-0 w-[1354px]" data-name="Container">
...
function Container10() {
  return (
    <div className="bg-white h-[600px] relative rounded-[8px] shrink-0 w-[1356px]" data-name="Container">
...
function AdminPage() {
  return (
    <div className="bg-[#f9fafb] h-[870px] relative shrink-0 w-full" data-name="AdminPage">
...
function MainLayout() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex flex-col h-[990px] items-start left-0 top-0 w-[1404px]" data-name="MainLayout">
      <TopUtilityBar3 />
      <HorizontalNavBar />
      <AdminPage />
    </div>
