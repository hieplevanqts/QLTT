import svgPaths from "./svg-itik13qbsc";
...
function Dropdown() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[46px] items-start left-[372px] pb-px pl-[-397px] pr-[571px] pt-[-142.5px] rounded-[8px] top-px w-[174px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Option />
      <Option1 />
      <Option2 />
...
function Dropdown1() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[46px] items-start left-[558px] pb-px pl-[-583px] pr-[773px] pt-[-142.5px] rounded-[8px] top-px w-[190px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Option7 />
      <Option8 />
      <Option9 />
...
function Dropdown2() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[46px] items-start left-[760px] pb-px pl-[-785px] pr-[1025px] pt-[-142.5px] rounded-[8px] top-px w-[240px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Option10 />
      <Option11 />
      <Option12 />
...
function HeaderCell() {
  return (
    <div className="absolute border-[#d0d5dd] border-r border-solid h-[54px] left-0 top-0 w-[96.391px]" data-name="Header Cell">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[21px] left-[14px] not-italic text-[#101828] text-[14px] top-[16px] tracking-[0.5px] uppercase whitespace-pre">Mã Job</p>
    </div>
  );
}
...
function HeaderCell1() {
  return (
    <div className="absolute border-[#d0d5dd] border-r border-solid h-[54px] left-[96.39px] top-0 w-[250px]" data-name="Header Cell">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[21px] left-[14.5px] not-italic text-[#101828] text-[14px] top-[16px] tracking-[0.5px] uppercase whitespace-pre">Tên nguồn</p>
    </div>
  );
}
...
function HeaderCell2() {
  return (
    <div className="absolute border-[#d0d5dd] border-r border-solid h-[54px] left-[346.39px] top-0 w-[149.344px]" data-name="Header Cell">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[21px] left-[14.5px] not-italic text-[#101828] text-[14px] top-[16px] tracking-[0.5px] uppercase whitespace-pre">Loại nguồn</p>
    </div>
  );
}
...
function HeaderCell3() {
  return (
    <div className="absolute border-[#d0d5dd] border-r border-solid h-[54px] left-[495.73px] top-0 w-[148.438px]" data-name="Header Cell">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[21px] left-[14.5px] not-italic text-[#101828] text-[14px] top-[16px] tracking-[0.5px] uppercase whitespace-pre">Người yêu cầu</p>
    </div>
  );
}
...
function HeaderCell4() {
  return (
    <div className="absolute border-[#d0d5dd] border-r border-solid h-[54px] left-[644.17px] top-0 w-[121.672px]" data-name="Header Cell">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[21px] left-[14.5px] not-italic text-[#101828] text-[14px] top-[16px] tracking-[0.5px] uppercase whitespace-pre">Trạng thái</p>
    </div>
  );
}
...
function HeaderCell5() {
  return (
    <div className="absolute border-[#d0d5dd] border-r border-solid h-[54px] left-[765.84px] top-0 w-[177.703px]" data-name="Header Cell">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[21px] left-[14.5px] not-italic text-[#101828] text-[14px] top-[16px] tracking-[0.5px] uppercase whitespace-pre">Thời gian yêu cầu</p>
    </div>
  );
}
...
function HeaderCell6() {
  return (
    <div className="absolute border-[#d0d5dd] border-r border-solid h-[54px] left-[943.55px] top-0 w-[212.328px]" data-name="Header Cell">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[21px] left-[14.5px] not-italic text-[#101828] text-[14px] top-[16px] tracking-[0.5px] uppercase whitespace-pre">Thời gian hoàn thành</p>
    </div>
  );
}
...
function HeaderCell7() {
  return (
    <div className="absolute border-[#d0d5dd] border-r border-solid h-[54px] left-[1155.88px] top-0 w-[113.359px]" data-name="Header Cell">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[21px] left-[57px] not-italic text-[#101828] text-[14px] text-center top-[16px] tracking-[0.5px] translate-x-[-50%] uppercase whitespace-pre">Số lần tải</p>
    </div>
  );
}
...
function HeaderCell8() {
  return (
    <div className="absolute border-[#d0d5dd] border-r border-solid h-[54px] left-[1269.23px] top-0 w-[190.609px]" data-name="Header Cell">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[21px] left-[14.5px] not-italic text-[#101828] text-[14px] top-[16px] tracking-[0.5px] uppercase whitespace-pre">Chính sách lưu trữ</p>
    </div>
  );
}
...
function HeaderCell9() {
  return (
    <div className="absolute h-[54px] left-[1459.84px] top-0 w-[104.594px]" data-name="Header Cell">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[21px] left-[14.5px] not-italic text-[#101828] text-[14px] top-[16px] tracking-[0.5px] uppercase whitespace-pre">Thao tác</p>
    </div>
  );
}
...
function TableRow() {
  return (
    <div className="absolute h-[54px] left-0 top-0 w-[1564.438px]" data-name="Table Row">
      <HeaderCell />
      <HeaderCell1 />
      <HeaderCell2 />
      <HeaderCell3 />
...
function TableHeader() {
  return (
    <div className="absolute bg-[#f2f4f7] border-[#d0d5dd] border-b-2 border-solid h-[54px] left-[2px] top-0 w-[1564.438px]" data-name="Table Header">
      <TableRow />
    </div>
  );
}
...
function TableCell3() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[81.5px] left-[491.73px] top-0 w-[148.438px]" data-name="Table Cell">
      <Text23 />
    </div>
  );
}
...
function Text24() {
  return (
    <div className="absolute bg-[#d4edda] h-[26px] left-[14.5px] rounded-[12px] top-[28.5px] w-[86.641px]" data-name="Text">
...
function TableCell4() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[81.5px] left-[640.17px] top-0 w-[121.672px]" data-name="Table Cell">
      <Text24 />
    </div>
  );
}
...
function Text25() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[14.5px] top-[33px] w-[112.281px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#101828] text-[14px] whitespace-pre">15/01/2025 15:30</p>
    </div>
  );
}
...
function TableCell5() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[81.5px] left-[761.84px] top-0 w-[177.703px]" data-name="Table Cell">
      <Text25 />
    </div>
  );
}
...
function TableCell6() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[81.5px] left-[939.55px] top-0 w-[212.328px]" data-name="Table Cell">
      <Text26 />
    </div>
  );
}
...
function Text27() {
  return (
    <div className="absolute bg-[#e3f2fd] h-[29px] left-[40.39px] rounded-[12px] top-[26.5px] w-[32.578px]" data-name="Text">
...
function TableCell7() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[81.5px] left-[1151.88px] top-0 w-[113.359px]" data-name="Table Cell">
      <Text27 />
    </div>
  );
}
...
function TableCell8() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[81.5px] left-[1265.23px] top-0 w-[190.609px]" data-name="Table Cell">
      <Text28 />
    </div>
  );
}
...
function Button29() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[34.55px] p-px rounded-[4px] size-[36px] top-[23px]" data-name="Button">
...
function TableCell9() {
  return (
    <div className="absolute h-[81.5px] left-[1455.84px] top-0 w-[104.594px]" data-name="Table Cell">
      <Button29 />
    </div>
  );
}
...
function TableRow1() {
  return (
    <div className="absolute border-[rgba(0,0,0,0)] border-b border-l-4 border-solid h-[81.5px] left-0 top-0 w-[1564.438px]" data-name="Table Row">
      <TableCell />
      <TableCell1 />
      <TableCell2 />
      <TableCell3 />
...
function Text31() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[14.5px] top-[32.5px] w-[116.984px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#101828] text-[14px] whitespace-pre">Trần Thị Kiểm Tra</p>
    </div>
  );
}
...
function TableCell13() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[81px] left-[491.73px] top-0 w-[148.438px]" data-name="Table Cell">
      <Text31 />
    </div>
  );
}
...
function Text32() {
  return (
    <div className="absolute bg-[#fff3cd] h-[26px] left-[14.5px] rounded-[12px] top-[28px] w-[87.938px]" data-name="Text">
...
function TableCell14() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[81px] left-[640.17px] top-0 w-[121.672px]" data-name="Table Cell">
      <Text32 />
    </div>
  );
}
...
function TableCell15() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[81px] left-[761.84px] top-0 w-[177.703px]" data-name="Table Cell">
      <Text33 />
    </div>
  );
}
...
function TableCell16() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[81px] left-[939.55px] top-0 w-[212.328px]" data-name="Table Cell">
      <Text34 />
    </div>
  );
}
...
function Text35() {
  return (
    <div className="absolute bg-[#f2f4f7] h-[29px] left-[40.05px] rounded-[12px] top-[26px] w-[33.25px]" data-name="Text">
...
function TableCell17() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[81px] left-[1151.88px] top-0 w-[113.359px]" data-name="Table Cell">
      <Text35 />
    </div>
  );
}
...
function TableCell18() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[81px] left-[1265.23px] top-0 w-[190.609px]" data-name="Table Cell">
      <Text36 />
    </div>
  );
}
...
function Icon33() {
  return (
    <div className="relative size-[18.315px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.3152 18.3152">
        <g id="Icon">
          <path d={svgPaths.p128c2860} id="Vector" stroke="var(--stroke-0, #856404)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.52627" />
        </g>
      </svg>
    </div>
  );
...
function Button30() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[34.55px] p-px rounded-[4px] size-[36px] top-[22.5px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="flex items-center justify-center relative shrink-0 size-[18.636px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[271.012deg]">
          <Icon33 />
        </div>
      </div>
    </div>
...
function TableCell19() {
  return (
    <div className="absolute h-[81px] left-[1455.84px] top-0 w-[104.594px]" data-name="Table Cell">
      <Button30 />
    </div>
  );
}
...
function TableRow2() {
  return (
    <div className="absolute border-[rgba(0,0,0,0)] border-b border-l-4 border-solid h-[81px] left-0 top-[81.5px] w-[1564.438px]" data-name="Table Row">
      <TableCell10 />
      <TableCell11 />
      <TableCell12 />
      <TableCell13 />
...
function Text40() {
  return (
    <div className="absolute bg-[#f8d7da] h-[26px] left-[14.5px] rounded-[12px] top-[28px] w-[58.141px]" data-name="Text">
...
function Text41() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[14.5px] top-[32.5px] w-[112.891px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#101828] text-[14px] whitespace-pre">15/01/2025 14:45</p>
    </div>
  );
}
...
function Container24() {
  return (
    <div className="absolute content-stretch flex gap-[4px] h-[36px] items-start justify-center left-[14.5px] top-[22.5px] w-[76.094px]" data-name="Container">
      <Button31 />
      <Button32 />
    </div>
  );
...
function TableRow3() {
  return (
    <div className="absolute border-[rgba(0,0,0,0)] border-b border-l-4 border-solid h-[81px] left-0 top-[162.5px] w-[1564.438px]" data-name="Table Row">
      <TableCell20 />
      <TableCell21 />
      <TableCell22 />
      <TableCell23 />
...
function Text48() {
  return (
    <div className="absolute bg-[#d4edda] h-[26px] left-[14.5px] rounded-[12px] top-[28px] w-[86.641px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-[12px] not-italic text-[#155724] text-[12px] top-[4px] whitespace-pre">Completed</p>
    </div>
  );
}
...
function Text49() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[14.5px] top-[32.5px] w-[116.109px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#101828] text-[14px] whitespace-pre">14/01/2025 23:20</p>
    </div>
  );
}
...
function Text50() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[14.5px] top-[32.5px] w-[115.578px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#155724] text-[14px] whitespace-pre">14/01/2025 23:25</p>
    </div>
  );
}
...
function Text51() {
  return (
    <div className="absolute bg-[#e3f2fd] h-[29px] left-[37.34px] rounded-[12px] top-[26px] w-[38.656px]" data-name="Text">
...
function TableRow4() {
  return (
    <div className="absolute bg-[rgba(255,243,224,0.3)] border-[#e65100] border-b border-l-4 border-solid h-[81px] left-0 top-[243.5px] w-[1564.438px]" data-name="Table Row">
      <TableCell30 />
      <TableCell31 />
      <TableCell32 />
      <TableCell33 />
...
function Text56() {
  return (
    <div className="absolute bg-[#e3f2fd] h-[26px] left-[14.5px] rounded-[12px] top-[28px] w-[71px]" data-name="Text">
...
function Text57() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[14.5px] top-[32.5px] w-[112.656px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#101828] text-[14px] whitespace-pre">15/01/2025 16:30</p>
    </div>
  );
}
...
function Text61() {
  return (
    <div className="absolute h-[18px] left-[46.55px] top-[31.5px] w-[12px]" data-name="Text">
...
function TableRow5() {
  return (
    <div className="absolute border-[rgba(0,0,0,0)] border-b border-l-4 border-solid h-[81px] left-0 top-[324.5px] w-[1564.438px]" data-name="Table Row">
      <TableCell40 />
      <TableCell41 />
      <TableCell42 />
      <TableCell43 />
...
function TableCell50() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[69px] left-[-4px] top-0 w-[96.391px]" data-name="Table Cell">
      <Code5 />
    </div>
  );
}
...
function Text62() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[14.5px] top-[26.5px] w-[211.031px]" data-name="Text">
...
function TableCell51() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[69px] left-[92.39px] top-0 w-[250px]" data-name="Table Cell">
      <Text62 />
    </div>
  );
}
...
function Text63() {
  return (
    <div className="absolute bg-[#e3f2fd] border border-[#90caf9] border-solid h-[28px] left-[14.5px] rounded-[6px] top-[20.5px] w-[100.938px]" data-name="Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-[10px] not-italic text-[#1976d2] text-[12px] top-[4px] whitespace-pre">REPORT_RUN</p>
    </div>
  );
}
...
function TableCell52() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[69px] left-[342.39px] top-0 w-[149.344px]" data-name="Table Cell">
      <Text63 />
    </div>
  );
}
...
function Text64() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[14.5px] top-[26.5px] w-[105.938px]" data-name="Text">
...
function TableCell53() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[69px] left-[491.73px] top-0 w-[148.438px]" data-name="Table Cell">
      <Text64 />
    </div>
  );
}
...
function Text65() {
  return (
    <div className="absolute bg-[#d4edda] h-[26px] left-[14.5px] rounded-[12px] top-[22px] w-[86.641px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-[12px] not-italic text-[#155724] text-[12px] top-[4px] whitespace-pre">Completed</p>
    </div>
  );
}
...
function TableCell54() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[69px] left-[640.17px] top-0 w-[121.672px]" data-name="Table Cell">
      <Text65 />
    </div>
  );
}
...
function Text66() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[14.5px] top-[26.5px] w-[113.438px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#101828] text-[14px] whitespace-pre">14/01/2025 21:00</p>
    </div>
  );
}
...
function TableCell55() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[69px] left-[761.84px] top-0 w-[177.703px]" data-name="Table Cell">
      <Text66 />
    </div>
  );
}
...
function Text67() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[14.5px] top-[26.5px] w-[110.313px]" data-name="Text">
...
function TableCell56() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[69px] left-[939.55px] top-0 w-[212.328px]" data-name="Table Cell">
      <Text67 />
    </div>
  );
}
...
function Text68() {
  return (
    <div className="absolute bg-[#e3f2fd] h-[29px] left-[40.22px] rounded-[12px] top-[20px] w-[32.922px]" data-name="Text">
...
function TableCell57() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[69px] left-[1151.88px] top-0 w-[113.359px]" data-name="Table Cell">
      <Text68 />
    </div>
  );
}
...
function Text69() {
  return (
    <div className="absolute bg-[#fff3cd] h-[26px] left-[14.5px] rounded-[8px] top-[22px] w-[57.469px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-[10px] not-italic text-[#856404] text-[12px] top-[4px] whitespace-pre">7 days</p>
    </div>
  );
}
...
function TableCell58() {
  return (
    <div className="absolute border-[rgba(208,213,221,0.3)] border-r border-solid h-[69px] left-[1265.23px] top-0 w-[190.609px]" data-name="Table Cell">
      <Text69 />
    </div>
  );
}
...
function Button34() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[34.55px] p-px rounded-[4px] size-[36px] top-[16.5px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <Icon37 />
    </div>
  );
...
function TableCell59() {
  return (
    <div className="absolute h-[69px] left-[1455.84px] top-0 w-[104.594px]" data-name="Table Cell">
      <Button34 />
    </div>
  );
}
...
function TableRow6() {
  return (
    <div className="absolute border-[rgba(0,0,0,0)] border-b border-l-4 border-solid h-[69px] left-0 top-[405.5px] w-[1564.438px]" data-name="Table Row">
      <TableCell50 />
      <TableCell51 />
      <TableCell52 />
      <TableCell53 />
...
function Text73() {
  return (
    <div className="absolute bg-[#e0e0e0] h-[26px] left-[14.5px] rounded-[12px] top-[28px] w-[81.328px]" data-name="Text">
...
function Text74() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[14.5px] top-[32.5px] w-[112.875px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#101828] text-[14px] whitespace-pre">13/01/2025 18:20</p>
    </div>
  );
}
...
function TableRow7() {
  return (
    <div className="absolute border-[rgba(0,0,0,0)] border-b border-l-4 border-solid h-[81px] left-0 top-[474.5px] w-[1564.438px]" data-name="Table Row">
      <TableCell60 />
      <TableCell61 />
      <TableCell62 />
      <TableCell63 />
...
function Text85() {
  return (
    <div className="absolute bg-[#e3f2fd] h-[29px] left-[40.19px] rounded-[12px] top-[26px] w-[32.969px]" data-name="Text">
...
function TableRow8() {
  return (
    <div className="absolute border-[rgba(0,0,0,0)] border-b border-l-4 border-solid h-[81px] left-0 top-[555.5px] w-[1564.438px]" data-name="Table Row">
      <TableCell70 />
      <TableCell71 />
      <TableCell72 />
      <TableCell73 />
...
function Text91() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[14.5px] top-[32.5px] w-[112.641px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#101828] text-[14px] whitespace-pre">11/01/2025 22:20</p>
    </div>
  );
}
...
function Text93() {
  return (
    <div className="absolute bg-[#e3f2fd] h-[29px] left-[37.42px] rounded-[12px] top-[26px] w-[38.5px]" data-name="Text">
...
function TableRow9() {
  return (
    <div className="absolute border-[rgba(0,0,0,0)] border-b border-l-4 border-solid h-[81px] left-0 top-[636.5px] w-[1564.438px]" data-name="Table Row">
      <TableCell80 />
      <TableCell81 />
      <TableCell82 />
      <TableCell83 />
...
function Text101() {
  return (
    <div className="absolute bg-[#e3f2fd] h-[29px] left-[40.31px] rounded-[12px] top-[26px] w-[32.734px]" data-name="Text">
...
function TableRow10() {
  return (
    <div className="absolute border-[rgba(0,0,0,0)] border-b border-l-4 border-solid h-[81px] left-0 top-[717.5px] w-[1564.438px]" data-name="Table Row">
      <TableCell90 />
      <TableCell91 />
      <TableCell92 />
      <TableCell93 />
...
function TableBody() {
  return (
    <div className="absolute h-[798.5px] left-[2px] top-[54px] w-[1564.438px]" data-name="Table Body">
      <TableRow1 />
      <TableRow2 />
      <TableRow3 />
      <TableRow4 />
...
function Table() {
  return (
    <div className="absolute h-[853px] left-px top-px w-[1566.438px]" data-name="Table">
      <TableHeader />
      <TableBody />
    </div>
  );
...
function Container28() {
  return (
    <div className="absolute bg-[#f2f4f7] content-stretch flex h-[111.5px] items-center justify-center left-px pb-0 pt-px px-0 top-[854px] w-[1484px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#d0d5dd] border-solid border-t inset-0 pointer-events-none" />
      <Pagination />
    </div>
  );
...
function Container29() {
  return (
    <div className="bg-white h-[966.5px] relative rounded-[8px] shrink-0 w-full" data-name="Container">
...
function AdminPage() {
  return (
    <div className="bg-[#f9fafb] h-[1582px] relative shrink-0 w-full" data-name="AdminPage">
