...
export const businessIcons: { [key: string]: string } = {
  // Ăn uống
 ...
 */
export function getBusinessIconWithSize(type: string, size: number): string {
 ...
 */
export function getIconSize(zoom: number): number {
