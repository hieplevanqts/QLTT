  ...
  M01: [
    {
      id: 'ins_qd_001',
      code: '01/QĐ-KT',
      title: 'Quyết định kiểm tra cơ sở kinh doanh thực phẩm Quận 1',
      issuedDate: '2026-01-05',
      issuedBy: 'Nguyễn Văn A',
      unit: 'Chi cục QLTT TP.HCM',
    ...
    },
    {
      id: 'ins_qd_002',
      code: '02/QĐ-KT',
      title: 'Quyết định kiểm tra cơ sở kinh doanh dược phẩm Quận 3',
  ...
  M03: [
    {
      ...
      unit: 'Cục QLTT TP.HCM',
      content: 'Giao quyền cho Chi cục trưởng Chi cục QLTT các quận/huyện',
    },
  ],
  M04: [
    {
